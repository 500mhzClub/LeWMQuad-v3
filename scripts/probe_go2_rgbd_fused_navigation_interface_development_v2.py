...
OUTPUT = ROOT/'.generated/go2_rgbd_fused_navigation_interface_development_v2_attempt_001'
PROTOCOL = 'docs/go2_rgbd_fused_navigation_interface_development_v2_2026-09-06.md'
SEEDS = (PROTOCOL, 'scripts/probe_go2_rgbd_fused_navigation_interface_development_v2.py',
...
def preflight():
    ...
    verify_bindings(bindings)
    sources = discover_sources(SEEDS, failed_launch['source_sha256'])
