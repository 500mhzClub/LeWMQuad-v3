...
def collect(trial, definition, *, output, model, geometry, persistent, episode_name, condition, variant):
    ...
    try:
        ...
        session._runtime['high_level'] = 'commitment_pose_goal_probe_v1; online model plus measured surfaces'
        ...
        controller = CommitmentPoseGoalProbe(model, geometry, persistent=persistent, condition=condition, variant=variant)
        try:
