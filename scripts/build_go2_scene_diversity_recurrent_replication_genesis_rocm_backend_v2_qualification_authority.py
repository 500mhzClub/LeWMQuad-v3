#!/usr/bin/env python3
"""Build, but never execute, the fresh V2 qualification authority."""
...
from scripts import run_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v2 as runner  # noqa: E402


AUTHORITY_OUTPUT = qualifier.QUALIFICATION_AUTHORITY
ROCM_BACKEND_SOURCE_AUDIT = {
    "audit_passed": True,
    "material_fresh_v2_ld_lld_driver_successor_not_v1_retry": True,
    ...
    "fresh_v2_role_local_quadrants_cache_required": True,
    ...
    "v1_terminal_review_document_exactly_bound": True,
    "v1_runtime_metadata_and_payload_reuse_forbidden": True,
    "direct_successor_and_focused_runtime_dependency_files_bound": True,
}


class GenesisRocmBackendV2AuthorityError(RuntimeError):
    """Raised before an incomplete V2 authority can be emitted."""


GenesisRocmBackendAuthorityError = GenesisRocmBackendV2AuthorityError
...
def file_binding(path: Path) -> dict[str, object]:
    try:
        ...
        raise GenesisRocmBackendV2AuthorityError(str(exc)) from exc
...
def _require_binding(
    ...
    if (
        ...
        raise GenesisRocmBackendV2AuthorityError(
...
def _validate_review(
    ...
    *,
    ...
    if (
        ...
        raise GenesisRocmBackendV2AuthorityError(
            "independent V2 source review changed"
        )
...
def build_qualification_authority(
    *,
    ...
    if set(authority) != qualifier.QUALIFICATION_AUTHORITY_FIELDS:
        raise GenesisRocmBackendV2AuthorityError(
            "V2 qualification authority fields changed"
        )
    return authority
...
__all__ = [
    ...
    "GenesisRocmBackendV2AuthorityError",
    "ROCM_BACKEND_SOURCE_AUDIT",
