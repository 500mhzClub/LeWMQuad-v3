...
from scripts.goal_hold_servo_session_development import GoalHoldServoSession
...
PREVIOUS=ROOT/'.generated/go2_course_aware_visual_servo_v1_attempt_001'
OUTPUT=ROOT/'.generated/go2_goal_hold_visual_servo_v1_attempt_001'
PROTOCOL='docs/go2_goal_hold_visual_servo_v1_2026-09-06.md'
IDENTITIES={'launch.json':'d6db89d7ba1c473b5f7fac46011ea7364291f101676d61f278ab90b08895808b',
    'result.json':'be1dd7c12be514dadb268d0ad52fc05410bc368afa2f8a3fee931f7477ad64fe'}
...
def preflight():
    ...
    sources=discover_sources((PROTOCOL,'scripts/run_go2_goal_hold_visual_servo_v1.py',
        'scripts/audit_go2_goal_hold_visual_servo_v1.py',
        'lewm/tests/test_goal_hold_visual_servo_development.py'),old['source_sha256'])
...
def collect(condition,definition):
    ...
    try:
        session=GoalHoldServoSession(spec,directory); session.install_contact_identity(); build=session.ctx.build
        ...
        motion=VisualLedMotion('gyro',identity=(0,0,0)); controller=GoalHoldVisualServo()
...
def main():
    ...
    try:
        ...
        write_json(OUTPUT/'result.json',dict(status='GOAL_HOLD_VISUAL_SERVO_COLLECTION_TERMINAL',conditions=results,
