...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        result = dict(status='RESIDUAL_ANCHORED_CONTINUATION_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('RESIDUAL_ANCHORED_CONTINUATION_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
