...
def audit(layout_index, result, definition, *, input_root, model, robot_geometry, episode_name, condition, variant):
    ...
    assert result['ordinary_waypoint_commitment_contact_enabled'] is True
    ...
    controller = DirectFlowCommitmentContactController(model, robot_geometry, public_mission=mission,
