...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = SustainedHoldReorientationController(model, geometry, public_mission=mission,
        ...
        result = dict(status='SUSTAINED_HOLD_REORIENTATION_MAZE02_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('SUSTAINED_HOLD_REORIENTATION_MAZE02_COLLECTED', result, flush=True)
        return result
    finally:
