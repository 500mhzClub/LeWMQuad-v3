...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = DirectFlowCommitmentContactController(model, geometry, public_mission=mission,
        ...
        result = dict(status='DIRECT_FLOW_COMMITMENT_CONTACT_MAZE02_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('DIRECT_FLOW_COMMITMENT_CONTACT_MAZE02_COLLECTED', result, flush=True)
        return result
    finally:
