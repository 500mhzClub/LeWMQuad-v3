...
from scripts import profile_go2_tiled_density_progressive_floor_late_history_v1 as run
...
SOURCE = 'scripts/verify_go2_tiled_density_progressive_floor_profile_completion_v1.py'
EXECUTION = 'docs/go2_tiled_density_progressive_floor_profile_execution_2026-09-11.json'
TEST = 'lewm/tests/test_tiled_density_progressive_floor_profile_completion_development.py'
OUTPUT = ROOT/'docs/go2_tiled_density_progressive_floor_profile_completion_verification_2026-09-11.json'
...
def verify_completed(result_sha, execution_sha):
    ...
    if (result['status'] != 'TILED_DENSITY_PROGRESSIVE_FLOOR_LATE_HISTORY_PROFILE_V1_COMPLETE'
