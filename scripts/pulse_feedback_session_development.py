...
from scripts.pulse_feedback_physical_init_development import PulseFeedbackPhysicalInit
...
class PulseFeedbackSession(RGBDSession,PulseFeedbackPhysicalInit):
