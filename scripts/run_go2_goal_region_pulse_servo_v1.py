...
from lewm.goal_region_pulse_scene_development import specification,TRIALS
...
from scripts.goal_region_pulse_session_development import GoalRegionPulseSession
...
PREVIOUS=ROOT/'.generated/go2_pulse_feedback_servo_v1_attempt_001'
OUTPUT=ROOT/'.generated/go2_goal_region_pulse_servo_v1_attempt_001'
PROTOCOL='docs/go2_goal_region_pulse_servo_v1_2026-09-06.md'
IDENTITIES={'launch.json':'f29a6309ca592248f07de6eae42d58c26a254ffe627abf5a9fd36c1ff6f9d786',
...
def preflight():
    ...
    sources=discover_sources((PROTOCOL,'scripts/run_go2_goal_region_pulse_servo_v1.py',
        'scripts/audit_go2_goal_region_pulse_servo_v1.py',
        'lewm/tests/test_goal_region_pulse_servo_development.py',
        'lewm/tests/test_goal_region_pulse_execution_development.py'),old['source_sha256'])
...
def collect(condition,definition):
    ...
    try:
        session=GoalRegionPulseSession(spec,directory); session.install_contact_identity(); build=session.ctx.build
        ...
        motion=VisualLedMotion('gyro',identity=(0,0,0)); controller=GoalRegionPulseServo()
...
def main():
    ...
    try:
        ...
        write_json(OUTPUT/'result.json',dict(status='GOAL_REGION_PULSE_SERVO_COLLECTION_TERMINAL',conditions=results,
