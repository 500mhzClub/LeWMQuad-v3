...
def audit(layout_index, result, definition, *, input_root, model, robot_geometry, episode_name, condition, variant):
    ...
    controller = DualCameraSettledController(model, robot_geometry, public_mission=mission,
    ...
    return dict(layout_index=layout_index, raw_sensor_reconstruction_pass=True, additional_auxiliary_rgb_reconstructed=True, raw_model_command_replay_pass=True,
