...
LABEL_PREFLIGHT_FAILURE_RELATIVE_PATH = (
    ".generated/go2_post_action_projective_support_labels_v4_preflight_failure.json"
)
...
def prepare_label_execution_binding_v1(
    *,
    ...
    contract.validate_label_v3_terminal_predecessor(root=root)
        ...
        binding = labels.with_content_sha256(
            {
                ...
                "label_v3_terminal_predecessor_bindings": {
                    name: dict(binding)
                    for name, binding in (
                        contract.LABEL_V3_TERMINAL_PREDECESSOR_BINDINGS.items()
                    )
                },
                "source_manifest": source_manifest,
                "independent_source_review": source_review,
