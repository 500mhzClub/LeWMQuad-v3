...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = HoldReorientationController(model, geometry, public_mission=mission,
        ...
        result = dict(status='HOLD_REORIENTATION_MAZE02_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
            ...
            hold_reorientation_enabled=True,
        ...
        print('HOLD_REORIENTATION_MAZE02_COLLECTED', result, flush=True)
        return result
    finally:
