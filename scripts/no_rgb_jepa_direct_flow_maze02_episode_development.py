...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = DirectFlowResidualAnchoredController(model, geometry, public_mission=mission,
        ...
        result = dict(status='NO_RGB_JEPA_DIRECT_FLOW_MAZE02_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('NO_RGB_JEPA_DIRECT_FLOW_MAZE02_COLLECTED', result, flush=True)
        return result
    finally:
