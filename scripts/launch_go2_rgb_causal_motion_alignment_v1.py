#!/usr/bin/env python3
"""Isolated no-tensor preflight for causal motion alignment V1."""
...
contract = _source_only_module(
    "_lewm_go2_rgb_causal_motion_alignment_v1_launcher_contract",
    ROOT / "lewm/benchmarks/go2_rgb_causal_motion_alignment_v1.py",
)
_BASE = _source_only_module(
    "_lewm_go2_rgb_causal_motion_alignment_v1_temporal_launcher",
