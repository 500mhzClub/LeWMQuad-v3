...
from scripts import build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1_qualification_authority as qualification_authority  # noqa: E402
...
AUTHORITY_OUTPUT = REPO_ROOT / (
    ...
    "genesis_rocm_backend_v3_integrity_replacement_v1_execution_authority_2026-08-04.json"
)
GenesisRocmBackendV3IntegrityReplacementV1AuthorityError = (
    qualification_authority.GenesisRocmBackendV3IntegrityReplacementV1AuthorityError
)
    ...
    *,
    ...
    authority = {
        ...
        "predecessor_v3_qualification_terminal_review_binding": (
            qualification_authority._v3_terminal_review_binding()  # noqa: SLF001
        ),
    }
    ...
    runner.collector._require_v3_review_binding(authority)  # noqa: SLF001
    return authority
