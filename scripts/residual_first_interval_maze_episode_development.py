...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = ResidualFirstIntervalController(model, geometry, public_mission=mission,
        ...
        result = dict(status='RESIDUAL_FIRST_INTERVAL_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
            ...
            measured_floor_transport_enabled=True, residual_first_interval_feasibility_fallback_enabled=True, renderer_witnesses_recorded=True,
        ...
        print('RESIDUAL_FIRST_INTERVAL_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
