#!/usr/bin/env python3
"""Persistent initial feedback through dwell, followed by the unchanged task."""
import ast
import contextlib
import json
...
from lewm.persistent_alignment_continuation_development import PersistentAlignedContinuation as ObservedContinuation
...
OUTPUT = ROOT / '.generated/go2_persistent_alignment_continuation_development_v1_attempt_001'
NEW_SOURCES = (
    'lewm/persistent_alignment_continuation_development.py',
    'lewm/persistent_alignment_scene_development.py',
    'lewm/tests/test_persistent_alignment_continuation_development.py',
    'scripts/run_go2_persistent_alignment_continuation_development_v1.py',
    'scripts/audit_go2_persistent_alignment_continuation_development_v1.py',
    'docs/go2_persistent_alignment_continuation_development_v1_2026-09-05.md')
LEAVES = (
...
def preflight():
    predecessor = ROOT / '.generated/go2_initially_aligned_continuation_development_v1_attempt_001'
    identities = {str((predecessor/leaf).relative_to(ROOT)): sha for leaf, sha in (
        ('launch.json', '369870d7e4546d49b3cb1c7740c56f4b39c392dce0acfc8232df35880f6222b9'),
        ('result.json', '91b003a0218c3108226300624f6a9038d77f51a6ddcbe12af0d2ec40b68c67cf'),
        ('raw_artifact_audit.json', '82907c2038aacdb82ae462a40e7b8f4a2e820c10a6a398ba7763d0f49c8ac744'))}
...
def main():
    ...
    specs = trials()
    OUTPUT.mkdir()
    write_json(OUTPUT/'launch.json', {'schema': 'persistent_alignment_continuation_development.v1', 'trial_specs': specs,
        'source_sha256': sources, 'input_sha256': inputs, 'gait_sha256': gait,
        'scope': 'sixteen persistent-feedback initial-alignment two-leg development trials; no independent-maze or hardware qualification'})
    rows, prefixes = [], {}
    try:
        for spec in specs:
