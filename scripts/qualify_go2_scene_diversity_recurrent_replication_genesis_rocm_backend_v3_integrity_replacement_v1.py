#!/usr/bin/env python3
"""Qualify the science-identical V3 integrity replacement V1.
...
probes remain unchanged.  Its complete source closure is captured before any
mutable predecessor overlay.
"""
...
from scripts import qualify_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3 as predecessor  # noqa: E402
...
QUALIFICATION_AUTHORITY_SCHEMA = (
    ...
    "genesis_rocm_backend_v3_integrity_replacement_v1_qualification_authority_v1"
)
QUALIFICATION_AUTHORITY_STATUS = (
    "AUTHORIZED_GENESIS_ROCM_BACKEND_V3_INTEGRITY_REPLACEMENT_V1_QUALIFICATION_ONLY"
)
...
QUALIFICATION_RESERVATION_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_"
    "genesis_rocm_backend_v3_integrity_replacement_v1_qualification_reservation_v1"
)
QUALIFICATION_SCENE_RESULT_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_"
    "genesis_rocm_backend_v3_integrity_replacement_v1_qualification_scene_result_v1"
)
QUALIFICATION_RESULT_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_"
    "genesis_rocm_backend_v3_integrity_replacement_v1_qualification_result_v1"
)
QUALIFICATION_TERMINAL_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_"
    "genesis_rocm_backend_v3_integrity_replacement_v1_qualification_terminal_v1"
)
QUALIFICATION_RESULT_STATUS = "PASS_GENESIS_ROCM_BACKEND_V3_INTEGRITY_REPLACEMENT_V1_QUALIFICATION"
...
PREREGISTRATION = REPO_ROOT / (
    ...
    "genesis_rocm_backend_v3_integrity_replacement_v1_preregistration_2026-08-04.md"
)
SOURCE_REVIEW = REPO_ROOT / (
    "docs/lewm_go2_scene_diversity_recurrent_replication_"
    "genesis_rocm_backend_v3_integrity_replacement_v1_source_review_2026-08-04.json"
)
QUALIFICATION_AUTHORITY = REPO_ROOT / (
    "docs/lewm_go2_scene_diversity_recurrent_replication_"
    "genesis_rocm_backend_v3_integrity_replacement_v1_qualification_authority_2026-08-04.json"
)
...
class GenesisRocmBackendV3IntegrityReplacementV1QualificationError(RuntimeError):
    """Raised when fresh V3 qualification fails closed."""


GenesisRocmBackendQualificationError = GenesisRocmBackendV3IntegrityReplacementV1QualificationError


def _source_paths() -> Mapping[str, Path]:
    from scripts import run_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1 as runner
...
def _run_rocm_egl_preflight(
    ...
    if expectation != plan_builder.ROCM_GRAPHICS_PREFLIGHT_EXPECTATION:
        raise GenesisRocmBackendV3IntegrityReplacementV1QualificationError(
    ...
    try:
        ...
        if plan_builder.QUALIFICATION_ATTEMPT_ROOT.is_dir():
            terminal = {
                ...
                "status": (
                    "FAIL_GENESIS_ROCM_BACKEND_V3_INTEGRITY_REPLACEMENT_V1_QUALIFICATION_HARD_STOP"
                ),
