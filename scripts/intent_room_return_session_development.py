...
from scripts.intent_room_return_physical_init_development import IntentRoomReturnPhysicalInit
...
class IntentRoomReturnSession(RGBDSession,IntentRoomReturnPhysicalInit):
