#!/usr/bin/env python3
"""Build scientific ROCm authority only after exact PASS qualification."""
...
from scripts import build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v1_qualification_authority as qualification_authority  # noqa: E402
...
AUTHORITY_OUTPUT = REPO_ROOT / (
    ...
    "genesis_rocm_backend_v1_execution_authority_2026-08-04.json"
)
GenesisRocmBackendAuthorityError = (
    qualification_authority.GenesisRocmBackendAuthorityError
)
...
def build_scientific_authority(
    *,
    ...
    if (
        ...
        raise GenesisRocmBackendAuthorityError(
            "scientific ROCm attempt root is not fresh"
        )
    cpu_review_binding = qualification_authority._cpu_terminal_review_binding()  # noqa: SLF001
    authority = {
        ...
        "predecessor_cpu_terminal_review_binding": cpu_review_binding,
    }
    if set(authority) != runner.collector.AUTHORITY_FIELDS:
        raise GenesisRocmBackendAuthorityError(
            "scientific authority fields changed"
        )
    return authority
