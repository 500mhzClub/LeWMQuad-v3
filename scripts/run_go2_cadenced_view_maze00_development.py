"""Fixed second exposed-maze mission with the same repaired controller."""
import argparse
...
REFERENCE = 'go2_short_pulse_navigation_supervised_rollout_noise_2mm_native_layout00_4800_v1_attempt_001'
...
def main():
    ...
    def write(name, value):
        if name == 'launch.json':
            value = value | dict(experiment='cadenced_view_age_navigation_v1',
                study_arm='supervised_rollout', comparison_condition='old_view_revisit_every_four_frames',
