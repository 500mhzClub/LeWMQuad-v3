...
import copy
import numpy as np
from lewm.bounded_visual_servo_scene_development import pack,specification
...
class ServoPhysicalInit(_GenesisPhysicalSession):
    def __init__(self,spec,*,backend):
        ...
        self._runtime=dict(backend='cpu',n_envs=1,physics_dt_s=.002,policy_dt_s=.02,command_dt_s=.1,
            ...
            ppo_observation_contact_inputs='none_in_frozen45elementcontract',high_level='sensor-only visual feedback',
