...
from scripts.auxiliary_depth_goal_sensor_audit_development import audit_rasters_and_footprints,audit_auxiliary
...
def audit(trial, result, definition, *, input_root, model, robot_geometry, persistent, episode_name, condition, variant):
    ...
    controller = AuxiliaryDepthReobserveGoalProbe(model, robot_geometry, persistent=persistent, condition=condition, variant=variant)
