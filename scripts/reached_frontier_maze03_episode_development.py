...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = ReachedFrontierRecentQualifiedController(model, geometry, public_mission=mission,
        ...
        result = dict(status='REACHED_FRONTIER_MAZE03_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
            ...
            measured_floor_transport_enabled=True, direct_corner_flow_missingness_fallback_enabled=True, renderer_witnesses_recorded=True,
            recent_qualified_anchor_enabled=True, reached_frontier_transition_enabled=True,
        ...
        print('REACHED_FRONTIER_MAZE03_COLLECTED', result, flush=True)
        return result
    finally:
