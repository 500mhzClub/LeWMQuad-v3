#!/usr/bin/env python3
"""Build or verify the V14 unified-ray-survival recursive source closure."""
...
SCHEMA = "lewm_go2_rgb_unified_ray_survival_joint_jepa_v14_source_manifest"
...
_V13 = _source_only_module(
    "_lewm_v14_unified_ray_survival_source_closure_base",
    BASE_CHECKER_PATH,
)
if Path(_V13.ROOT).resolve(strict=True) != ROOT.resolve(strict=True):
    raise PermissionError("V14 source-closure base escaped the repository")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("Go2 RGB unified-ray-survival joint JEPA V14 source closure: PASS")
    return 0
