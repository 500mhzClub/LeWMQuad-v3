...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = CommitmentContactController(model, geometry, public_mission=mission,
        ...
        result = dict(status='SUPERVISED_COMMITMENT_CONTACT_MAZE01_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
            ...
            commitment_contact_policy_enabled=True,
        ...
        print('SUPERVISED_COMMITMENT_CONTACT_MAZE01_COLLECTED', result, flush=True)
        return result
    finally:
