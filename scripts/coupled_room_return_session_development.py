...
from scripts.coupled_room_return_physical_init_development import CoupledRoomReturnPhysicalInit
...
class CoupledRoomReturnSession(RGBDSession,CoupledRoomReturnPhysicalInit):
