#!/usr/bin/env python3
"""Run the fixed-path Shared-JEPA V5 raw-supervision V3 exact audit."""
...
from lewm.datasets.go2_shared_jepa_v5_raw_supervision_auditor_v3 import (  # noqa: E402
    MAX_WORKERS,
