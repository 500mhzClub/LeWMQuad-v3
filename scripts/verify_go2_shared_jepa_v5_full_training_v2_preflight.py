...
if __name__ == "__main__":
    ...
    def _verify_source_closure(value: Mapping[str, Any]) -> None:
        ...
        if (
            ...
            or value.get("schema")
            != "lewm_go2_shared_jepa_v5_full_training_v2_preflight_source_closure_v1"
    ...
    def _verify_receipt(value: Mapping[str, Any]) -> None:
        ...
        expected_loss_components = {
            ...
            "v4_current_total",
            "v4_next_total",
            "v4_current_ordered_first_hit_nll",
    ...
    def verify(
        ...
        if (
            ...
            raise PermissionError("preflight implementation review hash changed")
        implementation_review = policy.validate_implementation_review(
            _parse(implementation_review_raw, "implementation review")
        )
        source_closure = values["source_closure.json"]
        if (
            source_closure.get("implementation_review_file_sha256")
            != implementation_review_sha256
            or source_closure.get("reviewed_sources")
            != implementation_review["reviewed_sources"]
        ):
            raise PermissionError("preflight implementation review closure changed")
        ...
        if (
            receipt.get("implementation_review_file_sha256")
            != implementation_review_sha256
        ...
        core = {
            "schema": "lewm_go2_shared_jepa_v5_full_training_v2_preflight_verification_v1",
            "status": "independently_reconstructed_pass",
            "implementation_review_file_sha256": implementation_review_sha256,
    ...
    def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
        ...
        if (
            ...
            or not policy.is_sha256(args.implementation_review_sha256)
        ):
