#!/usr/bin/env python3
"""Authority-first launcher for the Direct BEV V3 predictor probe."""
...
contract = _source_only_module(
    "_lewm_direct_bev_v3_film_unet_launcher_contract",
    ROOT
    / "lewm/benchmarks/"
...
if ROOT / contract.LAUNCHER_RELATIVE_PATH != Path(__file__).resolve():
    raise PermissionError("Direct-BEV V3 launcher path changed")
_V2 = _source_only_module(
    "_lewm_direct_bev_v3_film_unet_frozen_v2_launcher",
    ROOT / FROZEN_V2_LAUNCHER_RELATIVE_PATH,
)


def _rebind_inherited_launcher() -> None:
    """Bind the frozen V2 authority stack to only the V3 identities."""
