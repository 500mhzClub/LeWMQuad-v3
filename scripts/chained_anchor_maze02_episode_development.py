...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = ChainedAnchorResidualController(model, geometry, public_mission=mission,
        ...
        result = dict(status='CHAINED_ANCHOR_MAZE02_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
            ...
            direct_corner_flow_missingness_fallback_enabled=True, chained_retained_anchor_reacquisition_enabled=True,
        ...
        print('CHAINED_ANCHOR_MAZE02_COLLECTED', result, flush=True)
        return result
    finally:
