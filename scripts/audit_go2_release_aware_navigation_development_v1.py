...
from scripts.audit_release_aware_rgb_core_development import audit_trial as audit_rgb_trial
...
from scripts.run_go2_release_aware_navigation_development_v1 import (
...
def main():
    ...
    try:
        ...
        result = {'status': 'PASS', 'audited_trials': 2, 'trials': rows,
                  ...
                  'scope': 'continuous release-aware alignment development controller and physical outcomes; no independent-maze/JEPA/hardware qualification'}
