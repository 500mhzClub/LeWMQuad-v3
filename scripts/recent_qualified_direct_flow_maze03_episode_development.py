...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = RecentQualifiedDirectFlowController(model, geometry, public_mission=mission,
        ...
        result = dict(status='RECENT_QUALIFIED_DIRECT_FLOW_MAZE03_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('RECENT_QUALIFIED_DIRECT_FLOW_MAZE03_COLLECTED', result, flush=True)
        return result
    finally:
