"""Prospective persistent local visual recovery on exposed maze 0."""
import argparse
...
REFERENCE = 'go2_framewise_visual_support_supervised_rollout_noise_2mm_native_layout00_4800_v1_attempt_001'
...
def main():
    ...
    def write(name, value):
        if name == 'launch.json':
            value = value | dict(experiment='persistent_local_visual_v1',
                study_arm='supervised_rollout', comparison_condition='retain_local_view_objective_without_age_expiry',
