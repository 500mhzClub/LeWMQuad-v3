"""Recorded 100/200/300-ms journey with actual-interval chained association."""
...
OUTPUT = prefix.BASE/'go2_gapped_chained_flow_journey_v1_attempt_001'
...
def write(name, value):
    if name == 'launch.json':
        value = value | dict(successor_source_sha256=prefix.source.digest(Path(__file__)),
            ...
            predecessor_failure='go2_gapped_direct_flow_journey_v1_attempt_001',
            change='chained association follows actual acquired image times; 3.2-second lifetime retained',
