...
from lewm.measured_line_integral_navigation_development import MeasuredLineIntegralNavigation as WholeTaskNavigation
...
from scripts.run_go2_measured_region_navigation_development_v1 import preflight as prior_preflight, OUTPUT as PRIOR, verify_native

OUTPUT = ROOT/'.generated/go2_measured_line_integral_navigation_development_v1_attempt_001'
SCHEMA = 'measured_line_integral_navigation_development.v1'
NEW_SOURCES = (
    'lewm/measured_line_integral_navigation_development.py',
    'lewm/tests/test_measured_line_integral_navigation_development.py',
    'scripts/run_go2_measured_line_integral_navigation_development_v1.py',
    'scripts/audit_go2_measured_line_integral_navigation_development_v1.py',
    'scripts/audit_measured_line_integral_rgb_core_development.py',
    'lewm/tests/test_measured_line_integral_execution_development.py',
    'docs/go2_measured_line_integral_navigation_development_v1_2026-09-05.md',
    'docs/go2_measured_region_navigation_development_v1_result_2026-09-05.md')
...
def trial_specs():
    ...
    for spec in original_specs():
        ...
        spec['scene_id'] = 'go2-measured-line-integral-navigation-development-v1-'+spec['layout_name']
        spec['method'] = 'measured_line_integral'
        result.append(spec)
    return result
...
def preflight():
    ...
    if (inherited != launch['source_sha256'] or audit['status'] != 'PASS' or audit['audited_trials'] != 2):
        raise ValueError('source-bound completed measured-region audit required; all scientific failures retained')
