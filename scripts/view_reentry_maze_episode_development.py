...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = ViewReentryRoundTripController(model, geometry, public_mission=mission,
        ...
        result = dict(status='VIEW_REENTRY_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('VIEW_REENTRY_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
