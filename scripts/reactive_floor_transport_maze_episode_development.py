...
def collect(layout_index, definition, *, output, geometry, episode_name):
    ...
    try:
        ...
        controller = ReactiveFloorTransportController(geometry, public_mission=mission,
        ...
        result = dict(status='REACTIVE_FLOOR_TRANSPORT_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('REACTIVE_FLOOR_TRANSPORT_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
