#!/usr/bin/env python3
"""Compute-only exact verifier imported by the reviewed V10 executor.
...
def compute_four_equal_v9_losses_for_verification(
    ...
    """Independently reconstruct the reviewed V10 objective and V4 branches."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    raise PermissionError(
        "V10 verifier is compute-only; use the reviewed lifecycle-owning executor"
    )
