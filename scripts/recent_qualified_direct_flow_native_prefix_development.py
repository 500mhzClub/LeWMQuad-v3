...
INPUT_SHA='6be6aa6e60be4b1a9e3d9b79aa3b55e4becc3265fe208ce900c8e1962c3db3ea'
...
def admit_prefix(root,result):
    from scripts.replay_go2_recent_qualified_direct_flow_maze03_prefix_v1 import INPUT,CASE
    if (result['status']!='RECENT_QUALIFIED_DIRECT_FLOW_MAZE03_PREFIX_V1_COMPLETE'
    ...
    expected=dict(case=CASE[0],layout_index=3,model_state_sha256=MODEL_STATE,model_state_unchanged=True,
