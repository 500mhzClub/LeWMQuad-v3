...
from scripts.audit_depth_floor_hold_rgb_core_development import audit_trial as audit_rgb_trial
...
from scripts.run_go2_depth_floor_hold_navigation_development_v1 import (
...
def main():
    ...
    try:
        ...
        result = {'status': 'PASS', 'audited_trials': 2, 'trials': rows,
                  ...
                  'scope': 'continuous depth-floor observable-approach active-heading-hold development controller and physical outcomes; no independent-maze/JEPA/hardware qualification'}
