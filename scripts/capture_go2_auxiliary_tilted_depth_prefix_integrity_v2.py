...
from scripts.auxiliary_prefix_frame_acquisition_development import capture_frame
...
OUTPUT=BASE/'go2_auxiliary_tilted_depth_prefix_integrity_v2_attempt_001'
PROTOCOL='docs/go2_auxiliary_tilted_depth_prefix_integrity_v2_2026-09-08.md'
...
COMMAND_TICKS=19
FAILED=BASE/'go2_auxiliary_tilted_depth_prefix_integrity_v1_attempt_001'
FAILED_IDS={'launch.json':'d3ddd15fdc2439e3ef506336b07686ce7ef483f3b7e260b7c1183cb1739a2a8a',
    'failure.json':'ffc55133b4008d8ee590169380af265fa210dbebf24c7847db32b2fb2dacba81'}
...
def main():
    ...
    verify_artifacts(FAILED,FAILED_IDS);failed_launch=read_json(FAILED,'launch.json');verify(failed_launch)
    seeds=('scripts/capture_go2_auxiliary_tilted_depth_prefix_integrity_v2.py','lewm/tests/test_visible_robot_sensor_scope_development.py',
        ...
        'docs/go2_auxiliary_tilted_depth_prefix_integrity_v1_failure_2026-09-08.md',
        'lewm/tests/test_auxiliary_prefix_frame_acquisition_development.py')
    ...
    for name,sha in failed_launch['source_sha256'].items():
        if name in launch['source_sha256']:assert launch['source_sha256'][name]==sha
    sources=discover_sources((PROTOCOL,*seeds),launch['source_sha256']|geometry['source_sha256']|failed_launch['source_sha256'])
    ...
    launch.update(source_sha256=sources,input_artifact_sha256=input_ids,geometry_artifact_sha256=geometry_ids,
        ...
        robot_visualization_enabled=True,model_inference=False,fixed_command_replay=True,failed_predecessor_sha256=FAILED_IDS,
    ...
    print('AUXILIARY_TILTED_DEPTH_PREFIX_INTEGRITY_V2_LAUNCHED',digest(OUTPUT/'launch.json'),flush=True);start=time.perf_counter()
    try:
        ...
        verify(launch);verify_artifacts(INPUT,input_ids);verify_artifacts(GEOMETRY,geometry_ids);verify_artifacts(FAILED,FAILED_IDS)
        write_json(OUTPUT/'result.json',dict(status='AUXILIARY_TILTED_DEPTH_PREFIX_INTEGRITY_V2_COMPLETE',source_sha256=sources,
        ...
        print('AUXILIARY_TILTED_DEPTH_PREFIX_INTEGRITY_V2_COMPLETE',digest(OUTPUT/'result.json'),flush=True)
