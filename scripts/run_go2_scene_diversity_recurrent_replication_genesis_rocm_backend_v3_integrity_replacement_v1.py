#!/usr/bin/env python3
"""Run replacement V1 science only after exact replacement qualification."""
...
from scripts import build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1_plan as plan_builder  # noqa: E402
from scripts import collect_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1 as collector  # noqa: E402
from scripts import qualify_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1 as qualifier  # noqa: E402
from scripts import run_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3 as predecessor  # noqa: E402
...
SOURCE_REVIEW_SCHEMA = (
    ...
    "genesis_rocm_backend_v3_integrity_replacement_v1_source_review_v1"
)
SOURCE_REVIEW_STATUS = "PASS_INDEPENDENT_SOURCE_REVIEW"
RESULT_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_"
    "genesis_rocm_backend_v3_integrity_replacement_v1_result_v1"
)
TERMINAL_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_"
    "genesis_rocm_backend_v3_integrity_replacement_v1_terminal_v1"
)
RESERVATION_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_"
    "genesis_rocm_backend_v3_integrity_replacement_v1_attempt_reservation_v1"
)
...
_v3_source_paths = dict(predecessor.SOURCE_PATHS)
_v3_source_paths["v2_rocm_preregistration_source"] = (
    V2_PREREGISTRATION_SOURCE
)
if len(_v3_source_paths) != 220:
    raise RuntimeError("reviewed V3 source closure key count changed")
FROZEN_V3_SOURCE_PATHS = MappingProxyType(_v3_source_paths)

SOURCE_PATHS = MappingProxyType({
    **FROZEN_V3_SOURCE_PATHS,
    "rocm_backend_v3_integrity_replacement_v1_plan_builder": Path(
        plan_builder.__file__
    ).resolve(),
    "rocm_backend_v3_integrity_replacement_v1_collector": Path(
        collector.__file__
    ).resolve(),
    "rocm_backend_v3_integrity_replacement_v1_qualifier": Path(
        qualifier.__file__
    ).resolve(),
    "rocm_backend_v3_integrity_replacement_v1_runner": Path(__file__).resolve(),
    "rocm_backend_v3_integrity_replacement_v1_qualification_authority_builder": REPO_ROOT
    / "scripts/build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1_qualification_authority.py",
    "rocm_backend_v3_integrity_replacement_v1_scientific_authority_builder": REPO_ROOT
    / "scripts/build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1_authority.py",
    "rocm_backend_v3_integrity_replacement_v1_plan_test": REPO_ROOT
    / "lewm/tests/test_build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1_plan.py",
    "rocm_backend_v3_integrity_replacement_v1_collector_test": REPO_ROOT
    / "lewm/tests/test_collect_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1.py",
    "rocm_backend_v3_integrity_replacement_v1_qualifier_test": REPO_ROOT
    / "lewm/tests/test_qualify_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1.py",
    "rocm_backend_v3_integrity_replacement_v1_runner_test": REPO_ROOT
    / "lewm/tests/test_run_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1.py",
    "rocm_backend_v3_integrity_replacement_v1_qualification_authority_test": REPO_ROOT
    / "lewm/tests/test_build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1_qualification_authority.py",
    "rocm_backend_v3_integrity_replacement_v1_scientific_authority_test": REPO_ROOT
    / "lewm/tests/test_build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1_authority.py",
    "rocm_backend_v3_integrity_replacement_v1_preregistration": PREREGISTRATION,
    "rocm_backend_v3_integrity_replacement_v1_scientific_exact_plan": (
        plan_builder.DEFAULT_PLAN_OUTPUT
    ),
    "rocm_backend_v3_integrity_replacement_v1_qualification_exact_plan": (
        plan_builder.QUALIFICATION_PLAN_OUTPUT
    ),
    "predecessor_v3_qualification_terminal_review": (
        plan_builder.V3_QUALIFICATION_TERMINAL_REVIEW
    ),
})
...
def v2_preregistration_source_binding() -> dict[str, object]:
    ...
    if (
        FROZEN_V3_SOURCE_PATHS.get("v2_rocm_preregistration_source")
        != V2_PREREGISTRATION_SOURCE
...
def predecessor_failure_bindings_rocm() -> dict[str, dict[str, object]]:
    """Add only the permitted V3 review and exact causal source witness."""

    evidence = dict(_ORIGINAL_PREDECESSOR_FAILURE_BINDINGS())
    expected = _standard_binding(
        plan_builder.v3_qualification_terminal_review_binding()
    )
    if file_binding_v1(plan_builder.V3_QUALIFICATION_TERMINAL_REVIEW) != expected:
        raise SceneDiversityRunnerError(
            "V3 qualification terminal-review document changed"
        )
    evidence["predecessor_v3_qualification_terminal_review"] = expected
    evidence["v2_rocm_preregistration_source"] = (
        v2_preregistration_source_binding()
    )
    return evidence
...
def validate_qualification_result_binding(value: object):
    ...
    collector._require_v3_review_binding(authority)  # noqa: SLF001
...
def _validate_plan_rocm(
    ...
    except plan_builder.SceneDiversityGenesisRocmV3IntegrityReplacementV1PlanError as exc:
...
def _validate_authority_rocm(
    ...
    *,
    ...
    collector._require_v3_review_binding(validated[0])  # noqa: SLF001
    validate_qualification_result_binding(
