...
OUTPUT=BASE/'go2_auxiliary_tilted_depth_prefix_integrity_v1_attempt_001'
PROTOCOL='docs/go2_auxiliary_tilted_depth_prefix_integrity_v1_2026-09-08.md'
...
COMMAND_TICKS=19
FAILED=BASE/'go2_auxiliary_tilted_depth_prefix_v1_attempt_001'
FAILED_IDS={'launch.json':'1b05b3e771f29b54f79431b8a4af6f800b590c173a3b59a5ea9a0c84c69e50ca',
    'failure.json':'df0defa5c20888f67c077faa34cc6b0ddc2c2acc88434be01deb196c57fcb1e4'}
...
def main():
    ...
    seeds=('scripts/capture_go2_auxiliary_tilted_depth_prefix_integrity_v1.py','lewm/tests/test_visible_robot_sensor_scope_development.py',
        ...
        'docs/go2_auxiliary_tilted_depth_prefix_failure_2026-09-08.md')
    ...
    print('AUXILIARY_TILTED_DEPTH_PREFIX_INTEGRITY_LAUNCHED',digest(OUTPUT/'launch.json'),flush=True);start=time.perf_counter()
    try:
        ...
        write_json(OUTPUT/'result.json',dict(status='AUXILIARY_TILTED_DEPTH_PREFIX_INTEGRITY_COMPLETE',source_sha256=sources,
        ...
        print('AUXILIARY_TILTED_DEPTH_PREFIX_INTEGRITY_COMPLETE',digest(OUTPUT/'result.json'),flush=True)
