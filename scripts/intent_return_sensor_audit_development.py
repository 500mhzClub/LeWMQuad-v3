"""Independent native sensor reconstruction with cached, copied packet reads.

Successor of the frozen raw audit; physical checks and reconstruction unchanged.
The explicit reader includes the complete 3600-tick plus terminal-drain bound.
"""
import hashlib
import json
