#!/usr/bin/env python3
"""Build V2 scientific authority only after exact V2 qualification PASS."""
...
from scripts import build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v2_qualification_authority as qualification_authority  # noqa: E402
...
AUTHORITY_OUTPUT = REPO_ROOT / (
    ...
    "genesis_rocm_backend_v2_execution_authority_2026-08-04.json"
)
GenesisRocmBackendV2AuthorityError = (
    qualification_authority.GenesisRocmBackendV2AuthorityError
)
...
def build_scientific_authority(
    *,
    ...
    if (
        ...
        raise GenesisRocmBackendV2AuthorityError(
            "fresh V2 scientific attempt root changed"
        )
    authority = {
    ...
    if set(authority) != runner.collector.AUTHORITY_FIELDS:
        raise GenesisRocmBackendV2AuthorityError(
            "V2 scientific authority fields changed"
        )
    runner.collector._require_v1_review_binding(authority)  # noqa: SLF001
    return authority
