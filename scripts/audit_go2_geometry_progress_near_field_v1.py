...
from scripts.run_go2_geometry_progress_near_field_v1 import OUTPUT as INPUT,PROTOCOL,RESERVE,artifacts
...
def main():
    ...
    assert collection['status']=='GEOMETRY_PROGRESS_NEAR_FIELD_COLLECTION_TERMINAL'
