#!/usr/bin/env python3
"""Sixteen continuous two-leg observation-driven development trials."""
import ast
import contextlib
import json
...
OUTPUT = ROOT / '.generated/go2_observed_continuation_development_v1_attempt_001'
NEW_SOURCES = (
    'lewm/continuation_branch_development.py',
    'lewm/fixed_forward_traversal_development.py',
    'lewm/observed_continuation_development.py',
    'lewm/observed_continuation_scene_development.py',
    'lewm/observed_continuation_metrics_development.py',
    'lewm/tests/test_observed_continuation_development.py',
    'lewm/tests/test_observed_continuation_metrics_development.py',
    'lewm/tests/test_observed_continuation_evidence_development.py',
    'scripts/run_go2_observed_continuation_development_v1.py',
    'scripts/audit_go2_observed_continuation_development_v1.py',
    'docs/go2_observed_continuation_development_v1_2026-09-05.md')
LEAVES = (
...
def preflight():
    predecessor = ROOT / '.generated/go2_observed_traversal_development_v1_attempt_001'
    inputs = {str((predecessor / leaf).relative_to(ROOT)): sha for leaf, sha in (
        ('launch.json', '5597956c5847d56788112bb5029caabd4ed0b5c8918787b7ec95bed538ca54d0'),
        ('result.json', '6498693d8741a328b09f5c78df580e902c56af2a282e82468ffd802260cba33d'),
        ('raw_artifact_audit.json', 'b0c6bfea4284d47664f31533ad64cf292dca9c79c30db0f63abdaec9d9d901f1'))}
...
def main():
    ...
    specs = trials()
    OUTPUT.mkdir()
    write_json(OUTPUT/'launch.json', {'schema': 'observed_continuation_development.v1', 'trial_specs': specs,
        'source_sha256': sources, 'input_sha256': inputs, 'gait_sha256': gait,
        'scope': 'sixteen two-leg continuous development integrations; not independent-maze or hardware qualification'})
    rows, prefixes = [], {}
    try:
        for spec in specs:
