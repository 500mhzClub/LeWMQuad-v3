...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = CommitmentContactAnchoredController(model, geometry, public_mission=mission,
        ...
        result = dict(status='COMMITMENT_CONTACT_ANCHORED_MAZE02_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
            ...
            ordinary_waypoint_commitment_contact_enabled=True,
        ...
        print('COMMITMENT_CONTACT_ANCHORED_MAZE02_COLLECTED', result, flush=True)
        return result
    finally:
