...
from scripts import run_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1 as runner  # noqa: E402
...
class GenesisRocmBackendV3IntegrityReplacementV1AuthorityError(RuntimeError):
    """Raised before an incomplete V3 authority can be emitted."""


GenesisRocmBackendAuthorityError = GenesisRocmBackendV3IntegrityReplacementV1AuthorityError
...
def file_binding(path: Path) -> dict[str, object]:
    try:
        ...
        raise GenesisRocmBackendV3IntegrityReplacementV1AuthorityError(str(exc)) from exc
...
def _require_binding(
    ...
    if (
        ...
        raise GenesisRocmBackendV3IntegrityReplacementV1AuthorityError(
...
def _v1_terminal_review_binding() -> dict[str, Any]:
    return runner._standard_binding(  # noqa: SLF001
        plan_builder.predecessor.predecessor.V1_QUALIFICATION_TERMINAL_REVIEW_BINDING
    )


def _v2_terminal_review_binding() -> dict[str, Any]:
    return runner._standard_binding(  # noqa: SLF001
        plan_builder.predecessor.v2_qualification_terminal_review_binding()
    )
...
__all__ = [
    ...
    "GenesisRocmBackendV3IntegrityReplacementV1AuthorityError",
    "ROCM_BACKEND_SOURCE_AUDIT",
