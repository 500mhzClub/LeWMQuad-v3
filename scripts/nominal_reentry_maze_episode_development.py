...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = NominalReentryRoundTripController(model, geometry, public_mission=mission,
        ...
        result = dict(status='NOMINAL_REENTRY_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('NOMINAL_REENTRY_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
