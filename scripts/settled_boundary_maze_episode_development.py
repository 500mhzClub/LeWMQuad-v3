...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = SettledBoundaryRoundTripController(model, geometry, public_mission=mission,
        ...
        result = dict(status='SETTLED_BOUNDARY_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('SETTLED_BOUNDARY_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
