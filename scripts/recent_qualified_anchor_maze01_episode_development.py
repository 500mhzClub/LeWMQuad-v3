...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = RecentQualifiedAnchorController(model, geometry, public_mission=mission,
        ...
        result = dict(status='RECENT_QUALIFIED_ANCHOR_MAZE01_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('RECENT_QUALIFIED_ANCHOR_MAZE01_COLLECTED', result, flush=True)
        return result
    finally:
