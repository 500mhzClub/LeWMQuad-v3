...
OUTPUT=ROOT/'.generated/go2_pulse_training_pilot_v1_attempt_001'
PROTOCOL='docs/go2_pulse_training_pilot_v1_2026-09-06.md'
...
def preflight():
    ...
    sources=discover_sources((PROTOCOL,'scripts/run_go2_pulse_training_pilot_v1.py',
        'lewm/tests/test_pulse_timed_training_runner_development.py'),old['source_sha256'])
...
def run_fit(seed,arm,dataset,readers,schedule):
    ...
    for ids in schedule['batches']:
        ...
        logs.append(row);write_json(directory/'updates.json',logs)
