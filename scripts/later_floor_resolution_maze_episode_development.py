...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = LaterFloorResolutionRoundTripController(model, geometry, public_mission=mission,
        ...
        result = dict(status='LATER_FLOOR_RESOLUTION_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('LATER_FLOOR_RESOLUTION_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
