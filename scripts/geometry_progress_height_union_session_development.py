...
class GeometryProgressHeightUnionPhysicalInit(_GenesisPhysicalSession):
...
class GeometryProgressHeightUnionSession(RGBDSession,GeometryProgressHeightUnionPhysicalInit):
