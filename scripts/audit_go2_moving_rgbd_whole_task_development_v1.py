...
from scripts.audit_go2_whole_task_navigation_sampling_correction_development_v1 import audit_trial as audit_rgb_trial
...
from scripts.run_go2_moving_rgbd_whole_task_development_v1 import (
...
def main():
    ...
    try:
        ...
        result = {'status': 'PASS', 'audited_trials': 2, 'trials': rows,
                  ...
                  'scope': 'continuous sensor-state and unchanged RGB controller evidence; no navigation or JEPA qualification'}
