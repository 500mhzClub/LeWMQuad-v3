...
def audit(layout_index, result, definition, *, input_root, model, robot_geometry, episode_name, condition, variant):
    ...
    assert result['hold_reorientation_enabled'] is True
    assert result['sustained_hold_reorientation_enabled'] is True
    ...
    controller = SustainedHoldReorientationController(model, robot_geometry, public_mission=mission,
