"""Independent depth process and 2-ms simulation result release."""
import hashlib
...
OUTPUT=source.BASE/'go2_independent_depth_process_native_prefix_layout00_v1_attempt_001'
...
def write(name,value):
    if name=='launch.json':
        value=value|dict(host_real_time_execution_claimed=False,in_memory_camera_packets=True,
            ...
            simulation_release_resolution_ns=2_000_000,
