...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = ExecutedWaypointRoundTripController(model, geometry, public_mission=mission,
        ...
        result = dict(status='EXECUTED_WAYPOINT_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('EXECUTED_WAYPOINT_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
