...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = PartialHeightDirectFlowController(model, geometry, public_mission=mission,
        ...
        result = dict(status='PARTIAL_FLOOR_HEIGHT_MAZE01_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('PARTIAL_FLOOR_HEIGHT_MAZE01_COLLECTED', result, flush=True)
        return result
    finally:
