...
from scripts.run_go2_intent_room_return_v1 import OUTPUT
...
def audit_condition(c,result):
    ...
    old=read_npz(ROOT/'.generated/go2_coupled_room_return_v1_attempt_001'/c,'physics_trace.npz')
    ...
    model=IntentRoomReturn(spec['turn_sign'],load_fixed_table());desired=[]
...
def main():
    ...
    sources=discover_sources(('scripts/audit_go2_intent_room_return_v1.py',),launch['source_sha256'])
