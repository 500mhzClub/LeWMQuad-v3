"""Sixty-second prospective development probe after full-window short execution."""
import hashlib
from pathlib import Path
from lewm.eligible_floor_registration_development import bind
from lewm.independent_depth_process_development import (
    IndependentDepthProcessRuntime,initialize_obstacles,obstacles_ready)
...
OUTPUT=source.BASE/'go2_independent_depth_60s_native_layout00_v1_attempt_001'
...
def write(name,value):
    if name=='launch.json':
        value=value|dict(host_real_time_execution_claimed=False,in_memory_camera_packets=True,
            ...
            simulation_release_resolution_ns=2_000_000,prospective_duration_extension=True,
...
if __name__=='__main__':
    bind(source.main,OUTPUT=OUTPUT,COUNT=601,PacedNativeSession=InMemoryPairedCameraSession,write=write,
        ...
        MEASURED_RUNTIME_CLASS=IndependentDepthProcessRuntime,
