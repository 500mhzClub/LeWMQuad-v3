#!/usr/bin/env python3
"""Authority-first launcher for Next-Target Retrieval JEPA V10."""
...
contract = _source_only_module(
    (
        ...
        "v10_action_conditioned_next_target_retrieval_launcher_contract"
    ),
...
_BASE = _source_only_module(
    (
        "_lewm_go2_rgb_jepa_encoder_pretraining_"
        "v10_action_conditioned_next_target_retrieval_base_launcher"
    ),
...
# V10 deliberately defers the Torch-importing hardware child until after the
