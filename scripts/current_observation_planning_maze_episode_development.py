...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = CurrentObservationPlanningController(model, geometry, public_mission=mission,
        ...
        result = dict(status='CURRENT_OBSERVATION_PLANNING_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
            ...
            measured_floor_transport_enabled=True,
        planning_map_variant='current_paired_observation', persistent_contact_history_retained=True, selector_scan_state_retained=True, renderer_witnesses_recorded=True,
        ...
        print('CURRENT_OBSERVATION_PLANNING_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
