...
from scripts import build_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_development_v2_plan as plan_builder  # noqa: E402
...
PREREGISTRATION = REPO_ROOT / (
    ...
    "flat_development_v2_preregistration_2026-08-05.md"
)
PREREGISTRATION_SHA256 = (
    "ff50441e8eca4e1b05391dfd22137532e42a8c0c6d41626a7332323325350f51"
)
PREREGISTRATION_BYTE_COUNT = 9_087

QUALIFICATION_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_"
    "development_v2_qualification_result_v1"
)
DECISION_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_"
    "development_v2_qualification_decision_v1"
)
TERMINAL_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_"
    "development_v2_qualification_terminal_v1"
)
RESERVATION_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_"
    "development_v2_qualification_reservation_v1"
)
SCENE_RESULT_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_"
    "development_v2_scene_result_v1"
)
WORKER_FAILURE_SCHEMA = (
    "lewm_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_"
    "development_v2_worker_failure_v1"
)

PASS_STATUS = "PASS_GENESIS_CPU_FLAT_DEVELOPMENT_V2_QUALIFICATION"
FAIL_STATUS = "FAIL_GENESIS_CPU_FLAT_DEVELOPMENT_V2_QUALIFICATION"
...
def _read_and_validate_plan(
    ...
    if (
        ...
        or len(plan_builder.CPU_EXECUTION_ENVIRONMENT) != 10
...
def _child_environment(plan: Mapping[str, Any]) -> dict[str, str]:
    """Return only the exact fixed ten-key CPU environment."""
