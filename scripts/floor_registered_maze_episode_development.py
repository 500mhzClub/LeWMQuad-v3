...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = FloorRegisteredRoundTripController(model, geometry, public_mission=mission,
        ...
        result = dict(status='FLOOR_REGISTERED_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('FLOOR_REGISTERED_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
