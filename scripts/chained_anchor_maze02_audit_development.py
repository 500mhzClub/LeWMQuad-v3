...
def audit(layout_index, result, definition, *, input_root, model, robot_geometry, episode_name, condition, variant):
    ...
    assert result['direct_corner_flow_missingness_fallback_enabled'] is True
    assert result['chained_retained_anchor_reacquisition_enabled'] is True
    ...
    controller = ChainedAnchorResidualController(model, robot_geometry, public_mission=mission,
