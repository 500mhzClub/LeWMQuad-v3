"""Unchanged persistent local visual controller on exposed maze 1."""
import argparse
...
REFERENCE = 'go2_persistent_local_visual_supervised_rollout_noise_2mm_native_layout00_4800_v1_attempt_001'
    ...
    def write(name, value):
        if name == 'launch.json':
            value = value | dict(experiment='persistent_local_visual_v1',
                study_arm='supervised_rollout', comparison_condition='fixed_controller_second_exposed_layout',
