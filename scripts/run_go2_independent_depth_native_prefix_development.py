"""Prospective paired-depth reactive veto independent of the visual tracker."""
import hashlib
...
OUTPUT=source.BASE/'go2_independent_depth_native_prefix_layout00_v1_attempt_001'
...
def write(name,value):
    if name=='launch.json':
        value=value|dict(host_real_time_execution_claimed=False,in_memory_camera_packets=True,
            independent_current_depth_and_gyro_obstacles=True,simulator_lag_forces_zero=False,
...
if __name__=='__main__':
    bind(source.main,OUTPUT=OUTPUT,PacedNativeSession=InMemoryPairedCameraSession,write=write,
        ...
        MEASURED_RUNTIME_CLASS=IndependentDepthRuntime)()
