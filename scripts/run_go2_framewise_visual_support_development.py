"""Prospective camera-cadence visual support recovery on exposed maze 0."""
import argparse
...
REFERENCE = 'go2_prefix_aware_terminal_supervised_rollout_noise_2mm_native_layout00_4800_v1_attempt_001'
...
def main():
    ...
    def write(name, value):
        if name == 'launch.json':
            value = value | dict(experiment='framewise_visual_support_v1',
                study_arm='supervised_rollout', comparison_condition='camera_cadence_visual_support_recovery',
    ...
    with ProcessPoolExecutor(max_workers=1, mp_context=get_context('spawn'),
        ...
        def runtime(model, **kwargs):
            return FramewiseVisualSupportRuntime(model, prediction_source='neural',
