...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = ConfirmedFloorRoundTripController(model, geometry, public_mission=mission,
        ...
        result = dict(status='CONFIRMED_FLOOR_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('CONFIRMED_FLOOR_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
