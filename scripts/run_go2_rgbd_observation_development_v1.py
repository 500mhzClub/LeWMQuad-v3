...
from scripts.rgbd_session_development import RGBDSession as RouteSession
...
from scripts.run_go2_whole_task_navigation_sampling_correction_development_v1 import preflight as prior_preflight, OUTPUT as PRIOR
from scripts.analyze_go2_ground_plane_development_v1 import verify_bindings
from scripts.run_go2_successive_choice_maze_development_v1 import digest, write_json

OUTPUT = ROOT/'.generated/go2_rgbd_observation_development_v1_attempt_001'
NEW_SOURCES = (
    'lewm/causal_depth_observation_development.py', 'lewm/rgbd_dataset_development.py',
    'lewm/depth_geometry_evaluation_development.py', 'scripts/rgbd_session_development.py',
    'scripts/run_go2_rgbd_observation_development_v1.py', 'scripts/audit_go2_rgbd_observation_development_v1.py',
    'lewm/tests/test_causal_depth_observation_development.py', 'lewm/tests/test_rgbd_dataset_development.py',
    'lewm/tests/test_depth_geometry_evidence_development.py',
    'docs/go2_rgbd_observation_development_v1_2026-09-05.md')
LEAVES = (*RGB_LEAVES, 'fast_gyro_samples.npz', 'fast_gyro_histories.npz',
          'depth_observations.json', 'depth_camera_audit.json')
...
def trials():
    ...
    for index in (0, 2):
        ...
        spec.update(scene_id='go2-rgbd-observation-development-v1-'+spec['marker_case'],
...
def preflight():
    inherited, inputs, gait = prior_preflight()
    identities = {str((PRIOR/name).relative_to(ROOT)): sha for name, sha in (
        ('launch.json', 'a446d92c2cf5e4fd80391fb52073d5dd8ccfad25780a471a8610100abf322043'),
        ('result.json', 'dc87600fc6fa6ce96c5109b951db715f4ffff9b444dfcab5e7f353731db2b7da'),
        ('raw_artifact_audit.json', 'a9f92c26f66dbf79922b238dc0053dbd71f7b33d9e17aff04f2633cc7fb796d1'))}
    ...
    if inherited != launch['source_sha256'] or audit['status'] != 'PASS' or audit['audited_trials'] != 4:
...
def main():
    ...
    write_json(OUTPUT/'launch.json', {'schema': 'rgbd_observation_development.v1', 'trial_specs': specs,
