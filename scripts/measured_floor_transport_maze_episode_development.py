...
def collect(layout_index, definition, *, output, model, geometry, episode_name, condition, variant):
    ...
    try:
        ...
        controller = MeasuredFloorTransportController(model, geometry, public_mission=mission,
        ...
        result = dict(status='MEASURED_FLOOR_TRANSPORT_MAZE_TERMINAL_AUDIT_REQUIRED', layout_index=layout_index,
        ...
        print('MEASURED_FLOOR_TRANSPORT_MAZE_COLLECTED', result, flush=True)
        return result
    finally:
