...
from scripts.goal_region_pulse_physical_init_development import GoalRegionPulsePhysicalInit
...
class GoalRegionPulseSession(RGBDSession,GoalRegionPulsePhysicalInit):
