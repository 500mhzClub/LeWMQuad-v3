...
def audit(layout_index, result, definition, *, input_root, robot_geometry, episode_name):
    ...
    controller = ReactiveConnectorRoundTripController(robot_geometry, public_mission=mission,
    ...
    return dict(layout_index=layout_index, raw_sensor_reconstruction_pass=True, raw_controller_command_replay_pass=True,
