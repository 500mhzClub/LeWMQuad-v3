...
OUTPUT=BASE/'go2_direct_flow_maze01_prefix_v2_attempt_001'
PROTOCOL='docs/go2_direct_flow_maze01_prefix_v2_2026-09-09.md'
...
def main():
    ...
    sources=discover_sources((PROTOCOL,'scripts/replay_go2_direct_flow_maze01_prefix_v2.py',
    ...
    launch.update(protocol=PROTOCOL,source_sha256=sources,output_root=str(OUTPUT),replay_input_bindings=ids,
        predecessor_failure_bindings=FAILED_BINDINGS,live_sensor_contracts_use_unserialized_decision=True,
    ...
    try:
        ...
        write_json(OUTPUT/'result.json',dict(status='DIRECT_FLOW_MAZE01_PREFIX_V2_COMPLETE',source_sha256=sources,
