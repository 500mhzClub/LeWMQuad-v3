"""Fixed sequence test of local correspondence endpoint depth estimation."""
import argparse
import hashlib
import json
import os
...
def main():
    ...
    output = root/f'depth_noise_{args.sigma_mm}mm_local_feature_depth_tracking_601_v1'
    output.mkdir()
    ...
    with (output/'frames.jsonl').open('x') as sink:
        for frame in range(FRAME_COUNT):
            ...
            if frame % 100 == 0: print('LOCAL_FEATURE_DEPTH_FRAME', i, args.sigma_mm, frame, flush=True)
