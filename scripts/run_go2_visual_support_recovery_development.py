"""Prospective measured-view recovery on the exposed tracking-failure maze."""
import argparse
...
REFERENCE = 'go2_cadenced_view_age_250ms_supervised_rollout_noise_2mm_native_layout00_4800_v1_attempt_001'
...
def main():
    ...
    def write(name, value):
        if name == 'launch.json':
            value = value | dict(experiment='visual_support_recovery_v1',
                study_arm='supervised_rollout', comparison_condition='measured_local_visual_support_recovery',
    ...
    with ProcessPoolExecutor(max_workers=1, mp_context=get_context('spawn'),
        ...
        def runtime(model, **kwargs):
            return VisualSupportRuntime(model, prediction_source='neural',
