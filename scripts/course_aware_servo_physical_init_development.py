...
import copy
import numpy as np
from lewm.course_aware_visual_servo_scene_development import pack,specification
...
class CourseServoPhysicalInit(_GenesisPhysicalSession):
    def __init__(self,spec,*,backend):
        ...
        self._runtime=dict(backend='cpu',n_envs=1,physics_dt_s=.002,policy_dt_s=.02,command_dt_s=.1,
            ...
            ppo_observation_contact_inputs='none_in_frozen45elementcontract',high_level='sensor-only course-aware visual feedback',
