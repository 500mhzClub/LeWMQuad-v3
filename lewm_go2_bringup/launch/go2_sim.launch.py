...
def generate_launch_description():
    ...
    # Setup to launch the simulator and Gazebo world. The upstream launch declares
    # a gui argument but always starts the GUI. Keep this wrapper explicit so
    # headless simulator bring-up works on servers and CI.
