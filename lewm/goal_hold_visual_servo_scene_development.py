...
def specification(condition):
    ...
    return previous|dict(trial=condition,scene_id='goal-hold-visual-servo-v1-'+condition,
        family='CONTROLLED_FLOOR_GOAL_HOLD_VISUAL_SERVO',procedural_seed=2026090653,
        appearance_seed=2026090655,friction_mu=FRICTION[condition],
        geometry=previous['geometry']|dict(spawn_se2_world=[-.60,-.10,.06]),
