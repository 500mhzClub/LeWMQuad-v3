...
from lewm.observation_horizon_predictive_selection_development import select,require_short_forecast
...
def scan_rank(selection, delta):
    """Fixed 100-ms heading improvement, drift and learned contact cost."""
    ...
    result['score_contract']='one_observation_heading_improvement_minus_drift_and_contact'
...
class ObservationHorizonWaypointSelector:
