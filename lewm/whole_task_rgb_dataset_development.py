"""Policy-only whole-task reader with the fixed3606-frame acquisition budget."""
import json
...
def load_whole_task_observation(directory,index):
    ...
    if not isinstance(frames,list) or not 1<=len(frames)<=3606:
