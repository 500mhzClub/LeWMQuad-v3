...
class InnerGoalPulseServo(AnchoredPulseServo):
    ...
    def _result(self,now,command,diagnostic):
        return super()._result(now,command,diagnostic)|dict(
            controller='inner_goal_empirical_pulse_feedback_v1',
            internal_position_tolerance_m=INTERNAL_POSITION_TOLERANCE_M,fitting_audit_sha256=self.table.fitting_audit_sha256,
