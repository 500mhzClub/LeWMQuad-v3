"""Static contract for the authority-free N5 gate-aligned raster-NLL V15.

V15 deliberately has no execution token, authority object, capability, issuer,
...
IMPLEMENTATION_AUTHOR = "/root/camera_v12_gate_aligned_implementer"
AMENDMENT_AUTHOR = "/root/camera_v15_runtime_contract"
PREDECESSOR_IMPLEMENTATION_AUTHOR = "/root/camera_v5_independent"
V11_IMPLEMENTATION_AUTHOR = "/root/camera_v10_later_rung_plan"
V12_IMPLEMENTATION_AUTHOR = IMPLEMENTATION_AUTHOR
V12_REVIEWER = "/root/raw_v11_builder_auditor_diff"
V13_IMPLEMENTATION_AUTHOR = IMPLEMENTATION_AUTHOR
V13_REVIEWER = "/root/camera_v13_independent_review"
V14_IMPLEMENTATION_AUTHOR = IMPLEMENTATION_AUTHOR
V14_REVIEWER = "/root/camera_v14_independent_review"
V14_SOURCE_COMMIT = "3cb1e2f7316493dd62c9d44bd9878df6d1f6a0c6"
...
GPU_VISIBILITY_PREFLIGHT_RELATIVE_PATH = (
    "scripts/preflight_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v15_gpu_visibility.py"
)
...
SYNTHETIC_RELATIVE_PATH = (
    "lewm/tests/n5_gate_aligned_raster_nll_v15_synthetic_execution.py"
)
...
LIFECYCLE_TEST_RELATIVE_PATH = (
    "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v15_lifecycle.py"
)
RUNTIME_VISIBILITY_TEST_RELATIVE_PATH = (
    "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v15_runtime_visibility.py"
)
HANDOFF_RELATIVE_PATH = (
    "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v15_implementation_handoff_2026-07-14.md"
)
...
V14_RETAINED_SOURCE_AND_PROOF_BINDINGS = (
    ...
    (
        "lewm/benchmarks/go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v14.py",
        "7290d0021d04a3408d36bebede7a7726d764320ff7083fedbb958c98f9069f5a",
    ),
    (
        "scripts/train_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v14.py",
        "05c1da21db799e224b1623f032ac15e42b445a55812d5c06e16d31fe8d0701f4",
    ),
    (
        "scripts/verify_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v14.py",
        "5393dc04ada6ce77a49fa4506235fb431567712d4472db58a74e8ea1761f7d04",
    ),
    (
        "scripts/execute_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v14.py",
        "e1ab693555467202a2fa6a84f67e6a076313aa241d703c89df3a1adab19b7f51",
    ),
    (
        "lewm/tests/n5_gate_aligned_raster_nll_v14_synthetic_execution.py",
        "5a2f8cf73607cb61c870016d3881875038e13c345490a9e0bd1f97d9b2ae1887",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v14.py",
        "c540dd83143fe33c94275c39090a99725d635acc476336d44022e75d992fd702",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v14_lifecycle.py",
        "120d6f8334b36b59e6b3fd5f47210c901ff3ae30817e1882383c8be630effb9b",
    ),
    (
        "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v14_implementation_handoff_2026-07-14.md",
        "0d16a991cc25b515e58b9f0a79a10961f1db14b742b96eac3632e8ea480dbb84",
    ),
)
V14_REVIEW_RELATIVE_PATH = (
    "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v14_independent_review_2026-07-14.json"
)
V14_REVIEW_FILE_SHA256 = (
    "19f0082b587d94e50b7c4fac38e11f1af35bcd76ae1acaaf0e44c5ad2721e2ac"
)
V14_REVIEW_CONTENT_SHA256 = (
    "54c8c12953849e3515c4cb73e945033dcd3532450884500a94685cc02785a243"
)
V14_TERMINAL_BINDINGS = {
    "reservation": (
        ".generated/go2_observable_camera_ray_fit_v4/"
        "n5_gate_aligned_raster_nll_v14/attempts/seed_20260710/n5/"
        "reservation.json",
        "56abce14d8ba7901103bbd23353095c30180ca5361f7595b178da6e440ecea8c",
        "0aabc7ac8a468c6524ba66a244a11126c8e2c1d7587dbc1fafb3de71cc7d443b",
        23771,
    ),
    "failure": (
        ".generated/go2_observable_camera_ray_fit_v4/"
        "n5_gate_aligned_raster_nll_v14/attempts/seed_20260710/n5/failed.json",
        "df6d91925fb167bc72e41eb9a6f07657f246c6a7a95d3bf20734c747e639c704",
        "79560d4b5532ff41e428da913e28c6db235608da6cf4ea107fd33207870afad7",
        1296,
    ),
}
V14_TERMINAL_LOCK_RELATIVE_PATH = (
    ".generated/go2_observable_camera_ray_fit_v4/"
    "n5_gate_aligned_raster_nll_v14/attempts/seed_20260710/"
    ".n5.reservation-v14.lock"
)
V14_TERMINAL_LOCK_FILE_SHA256 = (
    "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
)
GPU_VISIBILITY_RECEIPT_PATH = Path(
    "/tmp/lewm_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v15_gpu_visibility_preflight_2026-07-14.json"
)
GPU_VISIBILITY_RECEIPT_SCHEMA = (
    "lewm_go2_observable_camera_ray_fit_v4_n5_gate_aligned_raster_nll_v15_"
    "gpu_visibility_preflight_v1"
)
GPU_VISIBILITY_DISPOSITIONS = (
    "pass_exactly_one_r9700",
    "gpu_runtime_unavailable",
    "gpu_device_count_mismatch",
    "gpu_device_identity_mismatch",
    "gpu_selector_mismatch",
    "native_thread_mismatch",
    "gpu_visibility_receipt_publication_failure",
)
EXPECTED_GPU_DEVICE_NAME = "AMD Radeon AI PRO R9700"
EXPECTED_GPU_LOGICAL_ORDINAL = 0
GPU_VISIBILITY_MAX_AGE_SECONDS = 600.0
GPU_VISIBILITY_THREAD_ENVIRONMENT = (
    "OMP_NUM_THREADS",
    "MKL_NUM_THREADS",
...
GPU_VISIBILITY_UNSET_SELECTORS = (
...
V13_AMENDMENT_RELATIVE_PATH = (
    "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v13_strict_review_binding_"
    "successor_amendment_2026-07-14.md"
)
V13_AMENDMENT_FILE_SHA256 = (
    "2eaaaa7b896dd42bed02d5a75072d1933b11ad4cce5e8d83f35f1d137ba89633"
)
V13_RETAINED_SOURCE_AND_PROOF_BINDINGS = (
    (
        "lewm/models/observable_camera_ray_evidence_v4_"
        "gate_aligned_raster_nll_v12.py",
        "735563f811c5d7b9efb9e37dca8348825a8467bd0a059f83ab94d41d45d57662",
    ...
    (
        "lewm/benchmarks/go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v13.py",
        "e5c03f0ed4a9cb82daeb040c2fe8f87a68911500c47c85992b2780b06f53082f",
    ),
    (
        "scripts/train_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v13.py",
        "92d6fef2a32498b4dc80566f73422b3735d2d9bbb39612b8a8946d7aa3a34d43",
    ),
    (
        "scripts/verify_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v13.py",
        "7fe1fa1f107478303c10cecd0b591388e1fdb042e14f0ad289f0b36ee399686b",
    ),
    (
        "scripts/execute_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v13.py",
        "77d7782078dc8b089f97144117d7dd0d8d0116dbfbe55a8b665335ee9de55a54",
    ),
    (
        "lewm/tests/n5_gate_aligned_raster_nll_v13_synthetic_execution.py",
        "19c6a1897b247760653c1329e46d389ab7a1b760074967f0e29ace9a19fd36b3",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v13.py",
        "2ebac0d62fa6c67e97ff174b301882cce73bda3b0f11bfa008ef23ff20745596",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v13_lifecycle.py",
        "d204e5ca88960bc8dc57f3acc328bff2387ca58cc15689624a61c357bc49ea85",
    ),
    (
        "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v13_implementation_handoff_2026-07-14.md",
        "054b64612b02623d6afc8d3c6cb5074a92855f00be007329b04451759b9f0c3d",
    ),
)
V13_REVIEW_RELATIVE_PATH = (
    "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v13_independent_review_2026-07-14.json"
)
V13_REVIEW_FILE_SHA256 = (
    "55ade66e943e3de1328fc63f536239ae3605f7edd6e8b7aae5a9b09bb33bdc3e"
)
V13_REVIEW_CONTENT_SHA256 = (
    "3125e0ca414d8baf3979cecea0464eee0830738345cf37706420d7d44b335330"
)
V12_AMENDMENT_RELATIVE_PATH = (
    "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v12_successor_amendment_2026-07-14.md"
)
V12_AMENDMENT_FILE_SHA256 = (
    "77de8c69b1bef69ab3d1b976567eb20371f53d47d81af757ef8c7fdaade93c1b"
)
V12_RETAINED_SOURCE_AND_PROOF_BINDINGS = (
    (
        "lewm/models/observable_camera_ray_evidence_v4_"
        "gate_aligned_raster_nll_v12.py",
        "735563f811c5d7b9efb9e37dca8348825a8467bd0a059f83ab94d41d45d57662",
    ...
    (
        "lewm/benchmarks/go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v12.py",
        "ad8a77c4f201f00891e7e6b45c395966eaa8f3723a3b2720d26eeb0b1ca23fc6",
    ),
    (
        "scripts/train_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v12.py",
        "91018ecd28483fbbc3399eea70d720a9b327e7e03b4920dbe349ca9b81603d54",
    ),
    (
        "scripts/verify_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v12.py",
        "f8814836c1073f13c563ba11035f806a0faa70be9a0d44b7d3e900350b1a8baf",
    ),
    (
        "scripts/execute_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v12.py",
        "4e4c45c85827ad4db6e65a4f02557fd6c5b1e9d97ada4ac4577cb0b6b099b521",
    ),
    (
        "lewm/tests/n5_gate_aligned_raster_nll_v12_synthetic_execution.py",
        "1cbcb80d3f6bec5b9ce536d6b4fa9bad645d170a4be6b4e8d1b261ad5f5dc453",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v12.py",
        "98a11ec91865ff106dd943a6b6468ca227018d92db4a346fcbbe9497a7d8d099",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v12_lifecycle.py",
        "77b5d05373613220a0de1d78236659f0c038e9f1a91f3a4efbf5cbcaa73936c1",
    ),
    (
        "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
        "gate_aligned_raster_nll_v12_implementation_handoff_2026-07-14.md",
        "21d4858035225e2454a3e7fec3e71fb8571e4d69e7a592c5822c4a435b17b0b9",
    ),
)
V12_REVIEW_RELATIVE_PATH = (
    "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
    "gate_aligned_raster_nll_v12_independent_review_2026-07-14.json"
)
V12_REVIEW_FILE_SHA256 = (
    "076855183730bcff58b507d8fde6c613a023b633681c7516daaf0d80b5e27158"
)
V12_REVIEW_CONTENT_SHA256 = (
    "4a56c46ede9482f72b5ae304734e12a706d8f7075873b4e5de135f9fa6cc289d"
)
V11_RETAINED_SOURCE_AND_PROOF_BINDINGS = (
    (
        "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v11_retained_gate_schema_adapter_"
        "successor_amendment_2026-07-14.md",
        "369a4428ebc574899106c78ee6b90416afdacb99ed6b6ca47cf620cbe4eeed3e",
    ),
    (
        "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v11_implementation_handoff_2026-07-14.md",
        "27c879957605b9bd25a98d76b12d394f71250aba476e65f2647875e2b09ae506",
    ),
    (
        "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v11_independent_review_2026-07-14.json",
        "f8b4c8705d05af84ab9ccabd39efcf4cdbfd625b40b44fb3703973aeedfc1836",
    ),
    (
        "lewm/models/observable_camera_ray_evidence_v4_"
    ...
    (
        "lewm/benchmarks/go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v11.py",
        "75b017d73181baaffb8e05931e0af7b53b4fd24b8a8b77740009fc7297e43cd5",
    ),
    (
        "scripts/train_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v11.py",
        "99de094c1df010f17c26d6f6109ff256a658d74f7799275bf572eae6afa5a1ae",
    ),
    (
        "scripts/verify_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v11.py",
        "7cf4d8e7649cd735156bf1e92b6f12b49754f804832a2af7c3ffc2b7229ddf51",
    ),
    (
        "scripts/execute_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v11.py",
        "401b46296fd367e2945d8e53844c0e80242ee1dc5bd5412f2a89f43fe4f22bc9",
    ),
    (
        "lewm/tests/n5_hierarchical_first_hit_v11_synthetic_execution.py",
        "baab30b06011aa80b922f1399d0d53666f7c08eb7a9991d4e4c30d4a04cb7d2a",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v11.py",
        "7818a89395eccb779094fd5ddc26107584ccc228fee3e8d4698896149f55749c",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v11_lifecycle.py",
        "80347c7b773733bdfc34b3f683d66614f712449c29287bb26ff6272c46efcc6c",
    ),
)
V11_REVIEW_CONTENT_SHA256 = (
    "8410cfb50be1673017f71151001720cfe5e1660c92486c5773d0ad286df5d656"
)
V11_OUTPUT_ROOT_RELATIVE_PATH = (
    ".generated/go2_observable_camera_ray_fit_v4/n5_hierarchical_first_hit_v11"
)
V11_TERMINAL_BINDINGS = {
    "reservation": (
        f"{V11_OUTPUT_ROOT_RELATIVE_PATH}/attempts/seed_20260710/n5/reservation.json",
        "d561b26fb455f2ef7dc5f4bba49156cd8c86c738ec7dc53694afa0abca2a3b29",
        "b8bc34b916c5a53a6ae5e4b28d7e280262edef32c51acf6b294aabd9655344f2",
    ),
    "result": (
        f"{V11_OUTPUT_ROOT_RELATIVE_PATH}/attempts/seed_20260710/n5/result.json",
        "73c6521cc1fc9431d7de18f812e1341c425b371539da7671aa37964355a3242d",
        "bf5731fc94b1af1614ff8fff5b48c4e598672115e193ba48b903c66af12c27e5",
    ),
    "completion": (
        f"{V11_OUTPUT_ROOT_RELATIVE_PATH}/attempts/seed_20260710/n5/completed.json",
        "663c8225b3c8dd51b4b0928a8d138ac43778f4401d3feff9a15a2cbbbf361f0d",
        "cd725130dd5a5b9faa4030c50d65e7ffa5aa6e4f818d6ca8d63d66df3cd1259d",
    ),
    "metric_verification": (
        f"{V11_OUTPUT_ROOT_RELATIVE_PATH}/metric_verifications/seed_20260710_n5.json",
        "1ea93e82db6bfbc649e06eb9ea54999d3c7501e0205021d3ca1a5c4d3b18635e",
        "845c0463dfb8f7d4b0488101a25be0301bdb55e7358994606f09057a7ed6fd4b",
    ),
    "gate": (
        f"{V11_OUTPUT_ROOT_RELATIVE_PATH}/gates/seed_20260710_n5.json",
        "74792618b41ca9084782aaa7fad5cbd18ce43b0276a16aaa51403b5812fcdbf4",
        "cb1bbe7eb4805cf29243c01b17f233083cec378ddc3df8b7682603e791f14293",
    ),
}
V10_RETAINED_SOURCE_AND_PROOF_BINDINGS = (
    ...
    (
        ...
        "9ff40daadcda1962de2d9d54def09b7ec5a128c0f7f3f14ee2449367f15481d5",
    ),
    (
        "scripts/train_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v10.py",
        "ec22c49855fe310f43bc72132a53e867604126db096e1064451e56f080259b1a",
    ),
    (
        "scripts/verify_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v10.py",
        "4ea17008e7805aba63a50415e8e9aefed31ebf70f1ccf803ec7e64e29a72cdbc",
    ),
    (
        "scripts/execute_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v10.py",
        "5387fbce1eb4c7c8cd1628fcf97c33a6bc7d15f8afd748a65760124d8f7002b4",
    ),
    (
        "lewm/tests/n5_hierarchical_first_hit_v10_synthetic_execution.py",
        "843a75dc295451190af43c255475cbe6541d6d305b448f5dde9bc173fcbb76d5",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v10.py",
        "d27e6a6e98d5fdec9d70b446d4f6f760b87cf0057ea0299db2131f252561f1a5",
    ),
    (
        "lewm/tests/test_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v10_lifecycle.py",
        "59f5a1a784586dba97170890a356e73b8b4005fb14b65f640437465289ba60a6",
    ),
    (
        "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v10_implementation_handoff_2026-07-14.md",
        "97a87facbef35c00b3fd7fe055ce04b603d8eba6cd0cb73cf5b399d3f8b45cb3",
    ),
    (
        "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v10_independent_review_2026-07-14.json",
        "0aa327d5f7fbf6eb291b4f7b23f0ecd71b2bf4ecd18a30f09ea2b788ecb26286",
    ),
)
V10_REVIEW_CONTENT_SHA256 = (
    "5012c2e15f23070112a329d21735e1778c2e44fb829f965fbc8df48e35852137"
)
V10_OUTPUT_ROOT_RELATIVE_PATH = (
    ".generated/go2_observable_camera_ray_fit_v4/n5_hierarchical_first_hit_v10"
)
V10_RESERVATION_RELATIVE_PATH = (
    f"{V10_OUTPUT_ROOT_RELATIVE_PATH}/attempts/seed_20260710/n5/reservation.json"
)
V10_RESERVATION_FILE_SHA256 = (
    "30f381e3442ac94f88de48b918e7edc95d13aae8e227d1efbba22bb39166d4e5"
)
V10_RESERVATION_CONTENT_SHA256 = (
    "4b709f9e5dc3cc7f1dee7d748f4cca7bad598d282159e9cacad1ca3d6b27e1df"
)
V10_RESERVATION_BYTE_COUNT = 12720
V10_VERIFICATION_FAILURE_RELATIVE_PATH = (
    f"{V10_OUTPUT_ROOT_RELATIVE_PATH}/attempts/seed_20260710/n5/"
    "verification_failure.json"
)
V10_VERIFICATION_FAILURE_FILE_SHA256 = (
    "2db93f56f3c3277c4d93833dcd0a281e96fad6cc86b8b8b0da1e547391c775b5"
)
V10_VERIFICATION_FAILURE_CONTENT_SHA256 = (
    "e05fe4c1b5a4b53d91019126ceb32c483f02ef3dcf7f1e16754a86c8f0b9841c"
)
V10_VERIFICATION_FAILURE_BYTE_COUNT = 6797
V10_FAILURE_RELATIVE_PATH = (
    f"{V10_OUTPUT_ROOT_RELATIVE_PATH}/attempts/seed_20260710/n5/failed.json"
)
V10_FAILURE_FILE_SHA256 = (
    "cfd10f1e384b996389b297feb0a9d199285aded3341dd8880e164941bdfc8005"
)
V10_FAILURE_CONTENT_SHA256 = (
    "1110fee5bba4735a17023694c5f508594c31e4ec5c2e7081c67d62f6cd5f5b24"
)
V10_FAILURE_BYTE_COUNT = 1759
...
ADDITIVE_LOSS_COMPONENT = "derived_raster_cell_nll"
LOSS_COMPONENTS = (*RETAINED_LOSS_COMPONENTS, ADDITIVE_LOSS_COMPONENT)
LOSS_ABSOLUTE_TOLERANCE = 1e-9
RETAINED_GATE_ADAPTER_VERSION = (
    "v15_native_diagnostics_excluded_then_hierarchical_to_ordered_key_v1"
)
THREAD_ENVIRONMENT = GPU_VISIBILITY_THREAD_ENVIRONMENT

SOURCE_REVIEW_SCHEMA = "lewm_go2_observable_camera_ray_fit_v4_n5_gate_aligned_raster_nll_v15_source_review_v1"
RESERVATION_SCHEMA = "lewm_go2_observable_camera_ray_fit_v4_n5_gate_aligned_raster_nll_v15_reservation_v1"
RESULT_SCHEMA = "lewm_go2_observable_camera_ray_fit_v4_n5_gate_aligned_raster_nll_v15_result_v1"
COMPLETION_SCHEMA = "lewm_go2_observable_camera_ray_fit_v4_n5_gate_aligned_raster_nll_v15_completion_v1"
FAILURE_SCHEMA = "lewm_go2_observable_camera_ray_fit_v4_n5_gate_aligned_raster_nll_v15_failure_v1"
METRIC_RECEIPT_SCHEMA = "lewm_go2_observable_camera_ray_fit_v4_n5_gate_aligned_raster_nll_v15_metric_verification_v1"
GATE_SCHEMA = "lewm_go2_observable_camera_ray_fit_v4_n5_gate_aligned_raster_nll_v15_gate_v1"
...
ATTEMPT_SCOPE = "one_exclusive_fresh_gate_aligned_raster_nll_v15_attempt"


def frozen_source_bindings() -> dict[str, str]:
    return {
        **dict(FROZEN_SOURCE_BINDINGS),
        V15_TERMINAL_V14_PROOF_CLARIFICATION_RELATIVE_PATH: (
            V15_TERMINAL_V14_PROOF_CLARIFICATION_FILE_SHA256
        ),
    }
...
def preflight_v15_source_authority_documents() -> dict[str, str]:
    """Rehash source-only V15 authorities without opening runtime evidence."""

    _hash_file(
        V15_AMENDMENT_RELATIVE_PATH,
        V15_AMENDMENT_FILE_SHA256,
        name="V15 gate-aligned raster-NLL amendment",
    )
    _hash_file(
        V15_TERMINAL_V14_PROOF_CLARIFICATION_RELATIVE_PATH,
        V15_TERMINAL_V14_PROOF_CLARIFICATION_FILE_SHA256,
        name="V15 terminal-V14 proof clarification",
    )
    return {
        V15_AMENDMENT_RELATIVE_PATH: V15_AMENDMENT_FILE_SHA256,
        V15_TERMINAL_V14_PROOF_CLARIFICATION_RELATIVE_PATH: (
            V15_TERMINAL_V14_PROOF_CLARIFICATION_FILE_SHA256
        ),
    }
...
def owned_directory_transaction_contract() -> dict[str, Any]:
    """V8's reviewed mutation protocol, retained unchanged for V15."""

    return {
        "scope": "every_mutation_at_or_below_the_exclusive_v15_output_root",
...
def isolated_verifier_contract() -> dict[str, Any]:
    return {
        ...
        "shared_production_gate_reconstruction_required": True,
        "retained_gate_adapter_version": RETAINED_GATE_ADAPTER_VERSION,
        "retained_n5_gate_check_count": 26,
        "process_bindings": [
            "isolated_flag",
            "no_bytecode_flag",
...
def gpu_visibility_contract() -> dict[str, Any]:
    return {
        "receipt_path": str(GPU_VISIBILITY_RECEIPT_PATH),
        "receipt_schema": GPU_VISIBILITY_RECEIPT_SCHEMA,
        "accepted_disposition": "pass_exactly_one_r9700",
        "dispositions": list(GPU_VISIBILITY_DISPOSITIONS),
        "expected_logical_ordinal": EXPECTED_GPU_LOGICAL_ORDINAL,
        "expected_device_name": EXPECTED_GPU_DEVICE_NAME,
        "maximum_age_seconds": GPU_VISIBILITY_MAX_AGE_SECONDS,
        "hip_visible_devices": "0",
        "unset_selectors": list(GPU_VISIBILITY_UNSET_SELECTORS),
        "hsa_override_absent": True,
        "native_thread_environment": list(GPU_VISIBILITY_THREAD_ENVIRONMENT),
        "native_and_torch_thread_count": 1,
        "diagnostic_before_reservation": True,
        "receipt_before_live_recheck": True,
        "data_rgb_checkpoint_output_opens_before_reservation": 0,
        "tensor_allocations": 0,
        "kernel_launches": 0,
        "pre_reservation_failure_consumes_attempt": False,
        "successful_reservation_is_first_output_mutation": True,
        "source_authority_documents": {
            V15_AMENDMENT_RELATIVE_PATH: V15_AMENDMENT_FILE_SHA256,
            V15_TERMINAL_V14_PROOF_CLARIFICATION_RELATIVE_PATH: (
                V15_TERMINAL_V14_PROOF_CLARIFICATION_FILE_SHA256
            ),
...
def authority_bindings() -> dict[str, Any]:
    return {
        "v15_gate_aligned_raster_nll_amendment": {
            "path": V15_AMENDMENT_RELATIVE_PATH,
            "file_sha256": V15_AMENDMENT_FILE_SHA256,
        },
        "v15_terminal_v14_proof_clarification": {
            "path": V15_TERMINAL_V14_PROOF_CLARIFICATION_RELATIVE_PATH,
            "file_sha256": V15_TERMINAL_V14_PROOF_CLARIFICATION_FILE_SHA256,
            "authority": "source_free_proof_closure_only",
        },
        "v14_source_commit": V14_SOURCE_COMMIT,
        "v14_gate_aligned_raster_nll_amendment": {
            "path": V14_AMENDMENT_RELATIVE_PATH,
            "file_sha256": V14_AMENDMENT_FILE_SHA256,
        },
        "v14_frozen_source_and_proof_chain": dict(
            V14_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v14_passing_source_review": {
            "path": V14_REVIEW_RELATIVE_PATH,
            "file_sha256": V14_REVIEW_FILE_SHA256,
            "content_sha256": V14_REVIEW_CONTENT_SHA256,
            "status": (
                "different_agent_review_passed_n5_gate_aligned_raster_nll_"
                "v14_scientific_successor"
            ),
            "reviewer": V14_REVIEWER,
            "exact_attempt_authorized": True,
        },
        "v14_consumed_terminal_runtime_failure": {
            **{
                role: {
                    "path": binding[0],
                    "file_sha256": binding[1],
                    "content_sha256": binding[2],
                    "byte_count": binding[3],
                }
                for role, binding in V14_TERMINAL_BINDINGS.items()
            },
            "lock": {
                "path": V14_TERMINAL_LOCK_RELATIVE_PATH,
                "file_sha256": V14_TERMINAL_LOCK_FILE_SHA256,
                "byte_count": 0,
            },
        },
        "v15_gpu_visibility_contract": gpu_visibility_contract(),
        "v13_gate_aligned_raster_nll_amendment": {
            "path": V13_AMENDMENT_RELATIVE_PATH,
            "file_sha256": V13_AMENDMENT_FILE_SHA256,
        },
        "v13_frozen_source_and_proof_chain": dict(
            V13_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v13_terminal_source_review_block": {
            "path": V13_REVIEW_RELATIVE_PATH,
            "file_sha256": V13_REVIEW_FILE_SHA256,
            "content_sha256": V13_REVIEW_CONTENT_SHA256,
            "status": "blocked_changed_digest_zero_open_contract_unsatisfied",
            "reviewer": V13_REVIEWER,
            "exact_attempt_authorized": False,
            "retry_authorized": False,
        },
        "v12_gate_aligned_raster_nll_amendment": {
            "path": V12_AMENDMENT_RELATIVE_PATH,
            "file_sha256": V12_AMENDMENT_FILE_SHA256,
        },
        "v12_frozen_source_and_proof_chain": dict(
            V12_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v12_terminal_source_review_block": {
            "path": V12_REVIEW_RELATIVE_PATH,
            "file_sha256": V12_REVIEW_FILE_SHA256,
            "content_sha256": V12_REVIEW_CONTENT_SHA256,
            "status": "blocked_nested_source_proof_binding_schema_is_open",
            "reviewer": V12_REVIEWER,
            "exact_attempt_authorized": False,
            "retry_authorized": False,
        },
        "v11_frozen_source_and_proof_chain": dict(
            V11_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v11_terminal_numeric_failure": {
            role: {
                "path": binding[0],
                "file_sha256": binding[1],
                "content_sha256": binding[2],
            }
            for role, binding in V11_TERMINAL_BINDINGS.items()
        },
        "v11_terminal_interpretation": {
            "status": "terminal_numeric_failure",
            "check_count": 26,
            "passed_check_count": 25,
            "failed_check_count": 1,
            "failed_check": "matched.raster_nll",
            "failed_value": 0.07255925759673118,
            "failed_threshold": 0.06,
            "checkpoint_input_authorized": False,
            "retry_authorized": False,
        },
        "v10_frozen_source_and_proof_chain": dict(
            V10_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v10_terminal_verifier_failure": {
            "reservation": {
                "path": V10_RESERVATION_RELATIVE_PATH,
                "file_sha256": V10_RESERVATION_FILE_SHA256,
                "content_sha256": V10_RESERVATION_CONTENT_SHA256,
                "byte_count": V10_RESERVATION_BYTE_COUNT,
            },
            "verification_failure": {
                "path": V10_VERIFICATION_FAILURE_RELATIVE_PATH,
                "file_sha256": V10_VERIFICATION_FAILURE_FILE_SHA256,
                "content_sha256": V10_VERIFICATION_FAILURE_CONTENT_SHA256,
                "byte_count": V10_VERIFICATION_FAILURE_BYTE_COUNT,
            },
            "failure": {
                "path": V10_FAILURE_RELATIVE_PATH,
                "file_sha256": V10_FAILURE_FILE_SHA256,
                "content_sha256": V10_FAILURE_CONTENT_SHA256,
                "byte_count": V10_FAILURE_BYTE_COUNT,
            },
            "retry_authorized": False,
...
def experiment_contract() -> dict[str, Any]:
    return {
        ...
        "retained_v11_loss_components": list(RETAINED_LOSS_COMPONENTS),
        "additive_v15_loss_component": ADDITIVE_LOSS_COMPONENT,
...
def licenses() -> dict[str, bool]:
    return {
        "authorizes_one_fresh_n5_gate_aligned_raster_nll_runtime_visibility_successor": True,
        ...
        "authorizes_v9_numeric_payload_read": False,
        "authorizes_v10_numeric_payload_read": False,
        "authorizes_v10_checkpoint_read": False,
        "authorizes_n16_execution": False,
        "authorizes_second_seed": False,
        "authorizes_later_v15_training": False,
        "authorizes_g2": False,
...
def preflight_static_authority() -> dict[str, Any]:
    ...
    preflight_v15_source_authority_documents()
    completed = subprocess.run(
        ["git", "merge-base", "--is-ancestor", V14_SOURCE_COMMIT, "HEAD"],
        cwd=ROOT,
    ...
    if completed.returncode != 0:
        raise PermissionError("V14 reviewed source-closure commit is not an ancestor")
    _hash_file(
        V14_AMENDMENT_RELATIVE_PATH,
        V14_AMENDMENT_FILE_SHA256,
        name="V14 review-open-order amendment",
    )
    for relative, digest in V14_RETAINED_SOURCE_AND_PROOF_BINDINGS:
        _hash_file(relative, digest, name=f"frozen V14 evidence {relative}")
    v14_review, _ = load_hashed_json(
        ROOT / V14_REVIEW_RELATIVE_PATH,
        V14_REVIEW_FILE_SHA256,
        name="V14 passing source review",
    )
    if (
        v14_review.get("content_sha256") != V14_REVIEW_CONTENT_SHA256
        or v14_review.get("schema")
        != (
            "lewm_go2_observable_camera_ray_fit_v4_n5_gate_aligned_"
            "raster_nll_v14_source_review_v1"
        )
        or v14_review.get("status")
        != (
            "different_agent_review_passed_n5_gate_aligned_raster_nll_"
            "v14_scientific_successor"
        )
        or v14_review.get("implementation_author") != V14_IMPLEMENTATION_AUTHOR
        or v14_review.get("reviewer") != V14_REVIEWER
        or v14_review.get("review_completed") is not True
        or v14_review.get("source_closure_approved") is not True
        or v14_review.get("exact_attempt_authorized") is not True
        or v14_review.get("scientific_successor_authorized") is not True
        or v14_review.get("scientific_retry_authorized") is not False
        or {
            **v14_review.get("successor_sources", {}),
            **v14_review.get("successor_proofs", {}),
        }
        != {
        ...
        raise PermissionError("V14 passing source review changed")
    v14_terminal: dict[str, dict[str, Any]] = {}
    for role, (relative, file_sha256, content_sha256, byte_count) in (
        V14_TERMINAL_BINDINGS.items()
    ):
        receipt, raw = load_hashed_json(
            ROOT / relative,
            file_sha256,
            name=f"V14 terminal {role}",
        )
        if (
            len(raw) != byte_count
            or receipt.get("content_sha256") != content_sha256
        ):
            raise PermissionError(f"V14 terminal {role} binding changed")
        v14_terminal[role] = receipt
    v14_failure = v14_terminal["failure"]
    v14_lock_raw = read_regular_bytes(
        ROOT / V14_TERMINAL_LOCK_RELATIVE_PATH,
        name="V14 terminal reservation lock",
    )
    if (
        v14_failure.get("status") != "failed"
        or v14_failure.get("failure")
        != {"class": "runtime", "code": "execution_failure"}
        or v14_failure.get("failure_stage") != "training"
        or v14_failure.get("retry_authorized") is not False
        or sorted(
            path.name
            for path in (ROOT / V14_TERMINAL_BINDINGS["reservation"][0]).parent.iterdir()
        )
        != ["failed.json", "reservation.json"]
        or v14_lock_raw != b""
        or hashlib.sha256(v14_lock_raw).hexdigest()
        != V14_TERMINAL_LOCK_FILE_SHA256
    ):
        raise PermissionError("V14 terminal runtime failure changed")
    _hash_file(
        V13_AMENDMENT_RELATIVE_PATH,
        V13_AMENDMENT_FILE_SHA256,
        name="V13 gate-aligned raster-NLL amendment",
    )
    for relative, digest in V13_RETAINED_SOURCE_AND_PROOF_BINDINGS:
        _hash_file(relative, digest, name=f"frozen V13 evidence {relative}")
    v13_review, _ = load_hashed_json(
        ROOT / V13_REVIEW_RELATIVE_PATH,
        V13_REVIEW_FILE_SHA256,
        name="V13 terminal source review BLOCK",
    )
    v13_authority = v13_review.get("authority")
    v13_findings = v13_review.get("findings")
    v13_finding = (
        v13_findings[0]
        if type(v13_findings) is list
        and len(v13_findings) == 1
        and type(v13_findings[0]) is dict
        else None
    )
    v13_evidence = (
        v13_finding.get("evidence") if type(v13_finding) is dict else None
    )
    v13_source_attack = (
        v13_evidence.get("source_digest_attack")
        if type(v13_evidence) is dict
        else None
    )
    v13_proof_attack = (
        v13_evidence.get("proof_digest_attack")
        if type(v13_evidence) is dict
        else None
    )
    if (
        v13_review.get("content_sha256") != V13_REVIEW_CONTENT_SHA256
        or v13_review.get("status")
        != "blocked_changed_digest_zero_open_contract_unsatisfied"
        or v13_review.get("reviewer") != V13_REVIEWER
        or v13_review.get("implementation_author") != V13_IMPLEMENTATION_AUTHOR
        or v13_review.get("review_completed") is not True
        or v13_review.get("source_closure_approved") is not False
        or v13_review.get("exact_attempt_authorized") is not False
        or v13_review.get("scientific_retry_authorized") is not False
        or type(v13_authority) is not dict
        or any(value is not False for value in v13_authority.values())
        or type(v13_finding) is not dict
        or v13_finding.get("code")
        != "self_consistent_changed_digest_opens_governed_target_before_rejection"
        or type(v13_source_attack) is not dict
        or v13_source_attack.get("canonical_enclosing_hashes_recomputed")
        is not True
        or v13_source_attack.get("governed_source_target_open_count") != 1
        or type(v13_proof_attack) is not dict
        or v13_proof_attack.get("canonical_enclosing_hashes_recomputed")
        is not True
        or v13_proof_attack.get("governed_source_target_open_count") != 5
        or v13_proof_attack.get("governed_proof_target_open_count") != 1
    ):
        raise PermissionError("V13 terminal source-review BLOCK changed")
    _hash_file(
        V12_AMENDMENT_RELATIVE_PATH,
        V12_AMENDMENT_FILE_SHA256,
        name="V12 gate-aligned raster-NLL amendment",
    )
    for relative, digest in V12_RETAINED_SOURCE_AND_PROOF_BINDINGS:
        _hash_file(relative, digest, name=f"frozen V12 evidence {relative}")
    v12_review, _ = load_hashed_json(
        ROOT / V12_REVIEW_RELATIVE_PATH,
        V12_REVIEW_FILE_SHA256,
        name="V12 terminal source review BLOCK",
    )
    v12_authority = v12_review.get("authority")
    v12_findings = v12_review.get("findings")
    if (
        v12_review.get("content_sha256") != V12_REVIEW_CONTENT_SHA256
        or v12_review.get("status")
        != "blocked_nested_source_proof_binding_schema_is_open"
        or v12_review.get("reviewer") != V12_REVIEWER
        or v12_review.get("implementation_author") != V12_IMPLEMENTATION_AUTHOR
        or v12_review.get("review_completed") is not True
        or v12_review.get("source_closure_approved") is not False
        or v12_review.get("exact_attempt_authorized") is not False
        or v12_review.get("scientific_retry_authorized") is not False
        or type(v12_authority) is not dict
        or any(value is not False for value in v12_authority.values())
        or type(v12_findings) is not list
        or len(v12_findings) != 1
        or type(v12_findings[0]) is not dict
        or v12_findings[0].get("code")
        != "nested_source_and_proof_bindings_accept_extra_fields"
        or v12_findings[0].get("reproduction")
        != {
            "unexpected_authority_claim_in_proof_binding_accepted": True,
            "unexpected_authority_claim_in_source_binding_accepted": True,
        }
    ):
        raise PermissionError("V12 terminal source-review BLOCK changed")
    for relative, digest in V11_RETAINED_SOURCE_AND_PROOF_BINDINGS:
        _hash_file(relative, digest, name=f"frozen V11 evidence {relative}")
    v11_review, _ = load_hashed_json(
        ROOT
        / (
            "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
            "hierarchical_first_hit_v11_independent_review_2026-07-14.json"
        ),
        dict(V11_RETAINED_SOURCE_AND_PROOF_BINDINGS)[
            "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
            "hierarchical_first_hit_v11_independent_review_2026-07-14.json"
        ],
        name="V11 terminal source review",
    )
    if v11_review.get("content_sha256") != V11_REVIEW_CONTENT_SHA256:
        raise PermissionError("V11 terminal source review content changed")
    v11_receipts: dict[str, dict[str, Any]] = {}
    for role, (relative, file_sha256, content_sha256) in V11_TERMINAL_BINDINGS.items():
        receipt, _ = load_hashed_json(
            ROOT / relative,
            file_sha256,
            name=f"V11 terminal {role}",
        )
        if receipt.get("content_sha256") != content_sha256:
            raise PermissionError(f"V11 terminal {role} content changed")
        v11_receipts[role] = receipt
    v11_gate = v11_receipts["gate"]
    v11_checks = v11_gate.get("numeric_gate", {}).get("checks", ())
    failed_checks = [row for row in v11_checks if row.get("passes") is False]
    if (
        v11_gate.get("status") != "terminal_numeric_failure"
        or v11_gate.get("passes") is not False
        or v11_gate.get("licenses", {}).get("retry_authorized") is not False
        or len(v11_checks) != 26
        or len(failed_checks) != 1
        or failed_checks[0].get("name") != "matched.raster_nll"
        or failed_checks[0].get("value") != 0.07255925759673118
        or failed_checks[0].get("threshold") != 0.06
    ):
        raise PermissionError("V11 terminal numeric-failure evidence changed")
    for relative, digest in V10_RETAINED_SOURCE_AND_PROOF_BINDINGS:
        _hash_file(relative, digest, name=f"frozen V10 evidence {relative}")
    v10_review_path = ROOT / (
        "docs/lewm_go2_observable_camera_ray_fit_v4_n5_"
        "hierarchical_first_hit_v10_independent_review_2026-07-14.json"
    )
    v10_review, _ = load_hashed_json(
        v10_review_path,
        "0aa327d5f7fbf6eb291b4f7b23f0ecd71b2bf4ecd18a30f09ea2b788ecb26286",
        name="V10 terminal source review",
    )
    if v10_review.get("content_sha256") != V10_REVIEW_CONTENT_SHA256:
        raise PermissionError("V10 terminal source review content changed")
    v10_reservation, v10_reservation_raw = load_hashed_json(
        ROOT / V10_RESERVATION_RELATIVE_PATH,
        V10_RESERVATION_FILE_SHA256,
        name="V10 terminal reservation",
    )
    v10_diagnostic, v10_diagnostic_raw = load_hashed_json(
        ROOT / V10_VERIFICATION_FAILURE_RELATIVE_PATH,
        V10_VERIFICATION_FAILURE_FILE_SHA256,
        name="V10 durable verifier diagnostic",
    )
    v10_failure, v10_failure_raw = load_hashed_json(
        ROOT / V10_FAILURE_RELATIVE_PATH,
        V10_FAILURE_FILE_SHA256,
        name="V10 terminal failure",
    )
    v10_attempt = (ROOT / V10_RESERVATION_RELATIVE_PATH).parent
    if (
        len(v10_reservation_raw) != V10_RESERVATION_BYTE_COUNT
        or len(v10_diagnostic_raw) != V10_VERIFICATION_FAILURE_BYTE_COUNT
        or len(v10_failure_raw) != V10_FAILURE_BYTE_COUNT
        or v10_reservation.get("content_sha256")
        != V10_RESERVATION_CONTENT_SHA256
        or v10_diagnostic.get("content_sha256")
        != V10_VERIFICATION_FAILURE_CONTENT_SHA256
        or v10_failure.get("content_sha256") != V10_FAILURE_CONTENT_SHA256
        or v10_diagnostic.get("status") != "verification_failed"
        or v10_diagnostic.get("retry_authorized") is not False
        or v10_failure.get("status") != "failed"
        or v10_failure.get("retry_authorized") is not False
        or sorted(path.name for path in v10_attempt.iterdir())
        != ["failed.json", "reservation.json", "verification_failure.json"]
    ):
        raise PermissionError("V10 terminal verifier evidence changed")
    _hash_file(
        V9_DIAGNOSIS_RELATIVE_PATH,
        V9_DIAGNOSIS_FILE_SHA256,
    ...
    return {
        ...
        "v14_terminal": {
            "source_commit": V14_SOURCE_COMMIT,
            "source_review_content_sha256": V14_REVIEW_CONTENT_SHA256,
            "reservation_content_sha256": V14_TERMINAL_BINDINGS["reservation"][2],
            "failure_content_sha256": V14_TERMINAL_BINDINGS["failure"][2],
            "lock_file_sha256": V14_TERMINAL_LOCK_FILE_SHA256,
        ...
        "v12_terminal_source_review_block": {
            "content_sha256": V12_REVIEW_CONTENT_SHA256,
            "status": v12_review["status"],
            "reviewer": V12_REVIEWER,
            "exact_attempt_authorized": False,
            "retry_authorized": False,
        },
        "v10_terminal": {
            "reservation_content_sha256": V10_RESERVATION_CONTENT_SHA256,
            "verification_failure_content_sha256": (
                V10_VERIFICATION_FAILURE_CONTENT_SHA256
            ),
            "failure_content_sha256": V10_FAILURE_CONTENT_SHA256,
            "retry_authorized": False,
        },
        "v11_terminal": {
            "gate_content_sha256": V11_TERMINAL_BINDINGS["gate"][2],
            "check_count": 26,
            "failed_check": "matched.raster_nll",
            "retry_authorized": False,
            "checkpoint_input_authorized": False,
...
def expected_source_review_core(
    *,
    ...
    return {
        ...
        "runtime_visibility_successor_authorized": True,
        ...
        "v9_numeric_payload_inspected": False,
        "v10_numeric_payload_inspected": False,
        "v10_checkpoint_inspected": False,
        "v14_terminal_source_review_inspected": True,
        "v14_terminal_lifecycle_evidence_inspected": True,
        "v14_numeric_payload_inspected": False,
        "v14_checkpoint_inspected": False,
        "retained_v14_source_commit": V14_SOURCE_COMMIT,
        "terminal_v14_proof_clarification": {
            "path": V15_TERMINAL_V14_PROOF_CLARIFICATION_RELATIVE_PATH,
            "file_sha256": V15_TERMINAL_V14_PROOF_CLARIFICATION_FILE_SHA256,
            "v14_retained_suite_expectation": (
                "234_passed_1_exact_pre_attempt_absence_node_deselected"
            ),
            "terminal_state_replacement_proof_required": True,
        },
        "retained_v14_amendment": {
            "path": V14_AMENDMENT_RELATIVE_PATH,
            "file_sha256": V14_AMENDMENT_FILE_SHA256,
        },
        "retained_v14_sources_and_proofs": dict(
            V14_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v14_passing_source_review": authority_bindings()[
            "v14_passing_source_review"
        ],
        "v14_terminal_runtime_failure": authority_bindings()[
            "v14_consumed_terminal_runtime_failure"
        ],
        "v13_terminal_source_review_inspected": True,
        "v13_checkpoint_inspected": False,
        "retained_v13_amendment": {
            "path": V13_AMENDMENT_RELATIVE_PATH,
            "file_sha256": V13_AMENDMENT_FILE_SHA256,
        },
        "retained_v13_sources_and_proofs": dict(
            V13_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v13_terminal_source_review_block": authority_bindings()[
            "v13_terminal_source_review_block"
        ],
        "v12_terminal_source_review_inspected": True,
        "v12_checkpoint_inspected": False,
        "retained_v12_amendment": {
            "path": V12_AMENDMENT_RELATIVE_PATH,
            "file_sha256": V12_AMENDMENT_FILE_SHA256,
        },
        "retained_v12_sources_and_proofs": dict(
            V12_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v12_terminal_source_review_block": authority_bindings()[
            "v12_terminal_source_review_block"
        ],
        "v11_terminal_receipts_inspected": True,
        "v11_checkpoint_inspected": False,
        "retained_v11_sources_and_proofs": dict(
            V11_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v11_terminal_numeric_failure": authority_bindings()[
            "v11_terminal_numeric_failure"
        ],
        "v11_terminal_interpretation": authority_bindings()[
            "v11_terminal_interpretation"
        ],
        "retained_v10_sources_and_proofs": dict(
            V10_RETAINED_SOURCE_AND_PROOF_BINDINGS
        ),
        "v10_terminal_failure_evidence": authority_bindings()[
            "v10_terminal_verifier_failure"
        ],
        ...
        "authority_boundary": {
            ...
            "scope": "one_exclusive_fresh_gate_aligned_raster_nll_v15_attempt",
            "retry_authorized": False,
            "scientific_retry_authorized": False,
            "v5_v6_v7_or_v8_numeric_state_authorized": False,
            "v8_checkpoint_input_authorized": False,
            "v9_or_v10_numeric_state_authorized": False,
            "v10_checkpoint_input_authorized": False,
            "v11_checkpoint_input_authorized": False,
            "v12_checkpoint_input_authorized": False,
            "v13_checkpoint_input_authorized": False,
            "v14_checkpoint_input_authorized": False,
            "v14_retry_authorized": False,
        ...
        "execution_contract": {
            ...
            "gpu_visibility_receipt_precedes_live_recheck": True,
            "live_visibility_recheck_precedes_output_freshness": True,
            "reservation_boundary_precedes_data_rgb_checkpoint_opens": True,
        },
        "gpu_visibility_contract": gpu_visibility_contract(),
...
def _validate_exact_successor_review_bindings(
    sources: Mapping[str, object],
    proofs: Mapping[str, object],
) -> tuple[dict[str, dict[str, str]], dict[str, dict[str, str]]]:
    """Validate every nested review binding before any governed file open."""

    expected_fields = {"path", "file_sha256"}
    staged: list[tuple[str, str, dict[str, object]]] = []
    for role, values, expected_paths in (
        ("source", sources, SUCCESSOR_SOURCE_PATHS),
        ("proof", proofs, SUCCESSOR_PROOF_PATHS),
    ):
        for relative in expected_paths:
            binding = values[relative]
            if type(binding) is not dict or set(binding) != expected_fields:
                raise PermissionError(
                    f"N5 gate-aligned raster-NLL V15 {role} binding fields changed"
                )
            path_value = binding["path"]
            digest_value = binding["file_sha256"]
            if type(path_value) is not str or type(digest_value) is not str:
                raise PermissionError(
                    f"N5 gate-aligned raster-NLL V15 {role} binding values changed"
                )
            if not is_sha256(digest_value):
                raise PermissionError(
                    f"N5 gate-aligned raster-NLL V15 {role} binding digest changed"
                )
            staged.append((role, relative, binding))

    bound_paths = [binding["path"] for _role, _relative, binding in staged]
    if len(set(bound_paths)) != len(bound_paths):
        raise PermissionError(
            "N5 gate-aligned raster-NLL V15 review contains duplicate binding paths"
        )

    checked_sources: dict[str, dict[str, str]] = {}
    checked_proofs: dict[str, dict[str, str]] = {}
    for role, relative, binding in staged:
        path_value = binding["path"]
        if path_value != relative:
            raise PermissionError(
                f"N5 gate-aligned raster-NLL V15 {role} binding path or role changed"
            )
        checked = {
            "path": path_value,
        ...
        if role == "source":
            checked_sources[relative] = checked
        else:
            checked_proofs[relative] = checked
    return checked_sources, checked_proofs
...
def preflight_source_review(path: Path, file_sha256: str) -> tuple[dict[str, Any], bytes]:
    ...
    if supplied != canonical:
        raise PermissionError("N5 gate-aligned raster-NLL V15 review path is not canonical")
    review, raw = load_hashed_json(
        canonical,
        file_sha256,
        name="N5 gate-aligned raster-NLL V15 different-agent source review",
    )
    ...
    if (
        ...
        raise PermissionError(
            "N5 gate-aligned raster-NLL V15 review is not by an independent agent"
        )
    checked, checked_proofs = _validate_exact_successor_review_bindings(
        sources,
        proofs,
    )
    ...
    if core != expected or canonical_json_sha256(core) != declared:
        raise PermissionError("N5 gate-aligned raster-NLL V15 review contract changed")
    for relative, binding in checked.items():
        source_raw = read_regular_bytes(ROOT / relative, name=f"V15 source {relative}")
        if hashlib.sha256(source_raw).hexdigest() != binding["file_sha256"]:
            raise PermissionError(
                f"N5 gate-aligned raster-NLL V15 source changed: {relative}"
            )
    for relative, binding in checked_proofs.items():
        proof_raw = read_regular_bytes(ROOT / relative, name=f"V15 proof {relative}")
        if hashlib.sha256(proof_raw).hexdigest() != binding["file_sha256"]:
            raise PermissionError(
                f"N5 gate-aligned raster-NLL V15 proof changed: {relative}"
            )
    return review, raw
...
def source_review_binding(review: Mapping[str, Any], file_sha256: str) -> dict[str, str]:
    if not is_sha256(file_sha256) or not is_sha256(review.get("content_sha256")):
        raise ValueError("N5 gate-aligned raster-NLL V15 review binding is malformed")
...
def _validate_loss_record(value: object, *, name: str) -> dict[str, float]:
    """Validate the retained four-term V11 gate-compatible loss record."""

    expected = set(RETAINED_LOSS_COMPONENTS) | {"total"}
    ...
    for key in (*RETAINED_LOSS_COMPONENTS, "total"):
        item = value[key]
    ...
    expected_total = 0.25 * sum(
        normalized[key] for key in RETAINED_LOSS_COMPONENTS
    )
    if not math.isclose(
        normalized["total"],
        expected_total,
...
def _validate_native_v15_objective(
    value: object,
    *,
    retained_losses: Mapping[str, float],
    name: str,
) -> dict[str, float]:
    expected = {"derived_raster_cell_nll", "v11_base_total", "total"}
    if not isinstance(value, Mapping) or set(value) != expected:
        raise ValueError(f"{name} native V15 objective fields changed")
    normalized: dict[str, float] = {}
    for key in ("derived_raster_cell_nll", "v11_base_total", "total"):
        item = value[key]
        if isinstance(item, bool) or not isinstance(item, (int, float)):
            raise ValueError(f"{name} native V15 objective {key} is not numeric")
        normalized[key] = float(item)
        if not math.isfinite(normalized[key]) or normalized[key] < 0.0:
            raise ValueError(f"{name} native V15 objective {key} is invalid")
    if not math.isclose(
        normalized["v11_base_total"],
        float(retained_losses["total"]),
        rel_tol=0.0,
        abs_tol=LOSS_ABSOLUTE_TOLERANCE,
    ):
        raise ValueError(f"{name} changed the retained V11 base total")
    expected_total = (
        normalized["v11_base_total"]
        + 0.25 * normalized["derived_raster_cell_nll"]
    )
    if not math.isclose(
        normalized["total"],
        expected_total,
        ...
        raise ValueError(f"{name} native V15 objective arithmetic is inconsistent")
    return normalized


def _validate_raster_nll_diagnostics(value: object, *, name: str) -> dict[str, Any]:
    if not isinstance(value, Mapping) or set(value) != {
        "overall",
        "by_target_class",
        "by_family",
    }:
        raise ValueError(f"{name} raster NLL diagnostic fields changed")

    def row(item: object, *, row_name: str) -> dict[str, Any]:
        if not isinstance(item, Mapping) or set(item) != {"count", "nll_sum", "mean"}:
            raise ValueError(f"{name} {row_name} raster NLL fields changed")
        count = item["count"]
        nll_sum = item["nll_sum"]
        mean = item["mean"]
        if isinstance(count, bool) or not isinstance(count, int) or count < 0:
            raise ValueError(f"{name} {row_name} raster NLL count is invalid")
        if isinstance(nll_sum, bool) or not isinstance(nll_sum, (int, float)):
            raise ValueError(f"{name} {row_name} raster NLL sum is not numeric")
        normalized_sum = float(nll_sum)
        if not math.isfinite(normalized_sum) or normalized_sum < 0.0:
            raise ValueError(f"{name} {row_name} raster NLL sum is invalid")
        expected_mean = None if count == 0 else normalized_sum / count
        if expected_mean is None:
            if mean is not None:
                raise ValueError(f"{name} {row_name} empty raster NLL mean changed")
        elif (
            ...
            raise ValueError(f"{name} {row_name} raster NLL mean is inconsistent")
        return {"count": count, "nll_sum": normalized_sum, "mean": expected_mean}

    overall = row(value["overall"], row_name="overall")
    classes = value["by_target_class"]
    class_names = ("UNKNOWN", "FREE", "OCCUPIED")
    if not isinstance(classes, Mapping) or set(classes) != set(class_names):
        raise ValueError(f"{name} raster NLL class partition changed")
    checked_classes = {
        class_name: row(classes[class_name], row_name=f"class {class_name}")
        for class_name in class_names
    }
    families = value["by_family"]
    if (
        not isinstance(families, Mapping)
        or not families
        or list(families) != sorted(families)
        or any(not isinstance(key, str) or not key for key in families)
    ):
        raise ValueError(f"{name} raster NLL family partition changed")
    checked_families = {
        family: row(item, row_name=f"family {family}")
        for family, item in families.items()
    }
    for partition_name, partition in (
        ("class", checked_classes),
        ("family", checked_families),
    ):
        if sum(item["count"] for item in partition.values()) != overall["count"]:
            raise ValueError(f"{name} raster NLL {partition_name} counts changed")
        if not math.isclose(
            sum(item["nll_sum"] for item in partition.values()),
            overall["nll_sum"],
            rel_tol=0.0,
            abs_tol=max(1e-10, 1e-12 * max(1.0, overall["nll_sum"])),
        ):
            raise ValueError(f"{name} raster NLL {partition_name} sums changed")
    return {
        "overall": overall,
...
def _validate_training_snapshot(value: object, *, name: str) -> dict[str, Any]:
    ...
    if set(components) != set(LOSS_COMPONENTS):
        raise ValueError(f"{name} V15 component fields changed")
    retained = _validate_loss_record(
        {
            **{key: components[key] for key in RETAINED_LOSS_COMPONENTS},
            "total": value["v11_base_total"],
        },
        name=name,
    )
    native = _validate_native_v15_objective(
        {
            "derived_raster_cell_nll": components[ADDITIVE_LOSS_COMPONENT],
            "v11_base_total": value["v11_base_total"],
            "total": value["total"],
        },
    ...
    return {
        "step": step,
        "total": native["total"],
        "v11_base_total": native["v11_base_total"],
        "components": {
            **{key: retained[key] for key in RETAINED_LOSS_COMPONENTS},
            ADDITIVE_LOSS_COMPONENT: native[ADDITIVE_LOSS_COMPONENT],
        },
...
def _validate_training_record(value: object) -> dict[str, Any]:
    ...
    if not isinstance(value, Mapping) or set(value) != expected_fields:
        raise ValueError("N5 gate-aligned raster-NLL V15 training fields changed")
    required = {
        "steps": 4000,
        "batch_size": 5,
        "evaluation_batch_size": 1,
    ...
    if any(value.get(key) != expected for key, expected in required.items()):
        raise PermissionError(
            "N5 gate-aligned raster-NLL V15 optimizer/exposure contract changed"
        )
    trace = value.get("trace")
    if not isinstance(trace, list) or len(trace) != 41:
        raise ValueError("N5 gate-aligned raster-NLL V15 diagnostic trace changed")
    checked_trace = [
        _validate_training_snapshot(row, name=f"V15 training trace[{index}]")
        for index, row in enumerate(trace)
    ]
    if tuple(row["step"] for row in checked_trace) != _expected_diagnostic_updates():
        raise PermissionError("N5 gate-aligned raster-NLL V15 trace indices changed")
    initial = _validate_training_snapshot(value.get("initial"), name="V15 initial")
    final = _validate_training_snapshot(value.get("final"), name="V15 final")
    if initial != checked_trace[0] or final != checked_trace[-1] or final["step"] != 4000:
        raise PermissionError(
            "N5 gate-aligned raster-NLL V15 did not select only update 4000"
        )
    return dict(value)
...
def validate_evaluation_structure(value: object) -> dict[str, Any]:
    if not isinstance(value, Mapping) or set(value) != {
        ...
        raise ValueError("N5 gate-aligned raster-NLL V15 evaluation controls changed")
    expected = {
    ...
    for key, (control, mapping, degenerate) in expected.items():
        ...
        if not isinstance(row, Mapping) or set(row) != {
            ...
            raise ValueError(f"N5 gate-aligned raster-NLL V15 {key} fields changed")
        if (
            ...
            raise ValueError(f"N5 gate-aligned raster-NLL V15 {key} control changed")
        retained_losses = _validate_loss_record(
            row["losses"], name=f"V15 {key} retained V11"
        )
        native = _validate_native_v15_objective(
            row["native_v15_objective"],
            retained_losses=retained_losses,
            name=f"V15 {key}",
        )
        diagnostics = _validate_raster_nll_diagnostics(
            row["raster_nll_diagnostics"], name=f"V15 {key}"
        )
        metric_raster = row["metrics"].get("derived_raster")
        if not isinstance(metric_raster, Mapping):
            raise ValueError(f"V15 {key} retained raster metrics are malformed")
        metric_count = metric_raster.get("count")
        metric_nll = metric_raster.get("nll")
        metric_nll_sum = metric_raster.get("nll_sum")
        if (
            isinstance(metric_count, bool)
            or not isinstance(metric_count, int)
            or metric_count != diagnostics["overall"]["count"]
            or isinstance(metric_nll, bool)
            or not isinstance(metric_nll, (int, float))
            or isinstance(metric_nll_sum, bool)
            or not isinstance(metric_nll_sum, (int, float))
            or not math.isfinite(float(metric_nll_sum))
            or float(metric_nll_sum) < 0.0
            or not math.isclose(
                float(metric_nll),
                native["derived_raster_cell_nll"],
                rel_tol=0.0,
                abs_tol=2e-7,
            )
            or not math.isclose(
                float(metric_nll),
                diagnostics["overall"]["mean"],
                rel_tol=0.0,
                abs_tol=2e-7,
            )
            or not math.isclose(
                float(metric_nll_sum),
                diagnostics["overall"]["nll_sum"],
                rel_tol=0.0,
                abs_tol=max(1e-5, 2e-7 * int(metric_count)),
            )
        ):
            raise ValueError(f"V15 {key} raster NLL recomputations disagree")
...
def adapt_native_v15_evaluation_for_retained_v4_gate(
    value: Mapping[str, Any],
) -> dict[str, Any]:
    """Return the sole private V11-compatible view accepted by the retained gate."""

    validate_evaluation_structure(value)
    original_sha256 = canonical_json_sha256(value)
    adapted = copy.deepcopy(dict(value))
    for control, gate_name in (
        ("matched_rgb", "matched"),
        ("wrong_rgb_with_target_calibration", "wrong-RGB"),
    ):
        original_row = value[control]
        adapted_row = adapted[control]
        original_losses = original_row["losses"]
        adapted_losses = adapted_row["losses"]
        native_objective = adapted_row.pop("native_v15_objective")
        diagnostics = adapted_row.pop("raster_nll_diagnostics")
        if (
            native_objective != original_row["native_v15_objective"]
            or diagnostics != original_row["raster_nll_diagnostics"]
        ):
            raise ValueError("V15 compatibility copy changed native diagnostics")
        source_value = original_losses["hierarchical_first_hit_nll"]
        if "ordered_first_hit_nll" in adapted_losses:
            raise ValueError("V15 compatibility input already has the retired key")
        removed = adapted_losses.pop("hierarchical_first_hit_nll")
        if removed != source_value:
            raise ValueError("V15 compatibility copy changed the first-hit value")
        adapted_losses["ordered_first_hit_nll"] = source_value
        if canonical_json_sha256(original_row["metrics"]) != canonical_json_sha256(
            adapted_row["metrics"]
        ):
            raise ValueError("V15 compatibility view changed metric bytes")
        for field in (
            "control",
            "wrong_rgb_degenerate_singleton",
            "image_index_mapping",
            ...
            if adapted_row[field] != original_row[field]:
                raise ValueError(f"V15 compatibility view changed {field}")
        from lewm.benchmarks import (
            go2_observable_camera_ray_fit_v4_ladder_gate as retained_gate,
        )

        retained_gate._validate_evaluation_losses(
            adapted_losses,
            name=gate_name,
        )
    if canonical_json_sha256(value) != original_sha256:
        raise ValueError("V15 retained-gate adapter mutated its caller")
    return adapted


def reconstruct_retained_v4_gate(
    evaluation: Mapping[str, Any],
    *,
    fit_size: int = 5,
) -> tuple[dict[str, Any], dict[str, Any], dict[str, Any], dict[str, Any]]:
    """Run the actual frozen retained gate through the single private adapter."""

    if isinstance(fit_size, bool) or fit_size != 5:
        raise ValueError("V15 retained-gate reconstruction requires fit_size=5")
    compatibility_view = adapt_native_v15_evaluation_for_retained_v4_gate(
        evaluation
    )
    from lewm.benchmarks import (
        go2_observable_camera_ray_fit_v4_ladder_gate as retained_gate,
    ...
    matched, wrong, signature = retained_gate._validated_metric_evaluation(
        compatibility_view,
        fit_size=fit_size,
    )
    numeric = retained_gate._gate_stage(
        {"fit_size": fit_size, "matched": matched, "wrong": wrong}
    )
    if numeric.get("check_count") != 26 or len(numeric.get("checks", ())) != 26:
        raise ValueError("V15 retained N5 gate did not produce exactly 26 checks")
    return matched, wrong, signature, numeric


def validate_gpu_visibility_reservation_binding(
    value: object,
    *,
    ...
    expected_fields = {
        ...
        "repository_commit",
        "live_recheck_disposition",
        "live_recheck_completed_before_reservation",
    }
    if type(value) is not dict or set(value) != expected_fields:
        raise ValueError("N5 V15 GPU visibility reservation binding changed")
    if (
        value.get("receipt_path") != str(GPU_VISIBILITY_RECEIPT_PATH)
        or value.get("receipt_schema") != GPU_VISIBILITY_RECEIPT_SCHEMA
        or value.get("receipt_disposition") != "pass_exactly_one_r9700"
        or value.get("live_recheck_disposition") != "pass_exactly_one_r9700"
        or value.get("live_recheck_completed_before_reservation") is not True
        or value.get("source_review_file_sha256")
        != expected_source_review["file_sha256"]
        or value.get("source_review_content_sha256")
        != expected_source_review["content_sha256"]
        or not all(
        ...
        raise PermissionError("N5 V15 GPU visibility reservation authority changed")
    return dict(value)
...
def validate_reservation_structure(reservation: Mapping[str, Any], *, expected_source_review: Mapping[str, str]) -> dict[str, Any]:
    ...
    declared = core.pop("content_sha256", None)
    if not is_sha256(declared) or canonical_json_sha256(core) != declared:
        raise ValueError("N5 gate-aligned raster-NLL V15 reservation hash changed")
    ...
    if not isinstance(recovery, list) or any(not isinstance(item, Mapping) for item in recovery):
        raise ValueError("N5 gate-aligned raster-NLL V15 recovery ledger is malformed")
    shadow = copy.deepcopy(dict(reservation))
    shadow.pop("preclaim_recovery")
    visibility = shadow.pop("gpu_visibility", None)
    ...
    if (
        ...
        or validate_gpu_visibility_reservation_binding(
            visibility,
        ...
        raise ValueError("N5 gate-aligned raster-NLL V15 reservation contract changed")
...
def validate_result_structure(result: Mapping[str, Any], *, expected_source_review: Mapping[str, str] | None = None) -> dict[str, Any]:
    ...
    if set(result) != expected_fields or result.get("schema") != RESULT_SCHEMA:
        raise ValueError("N5 gate-aligned raster-NLL V15 result schema changed")
    core = dict(result)
    declared = core.pop("content_sha256", None)
    if not is_sha256(declared) or canonical_json_sha256(core) != declared:
        raise ValueError("N5 gate-aligned raster-NLL V15 result hash changed")
    if (
        result.get("mode")
        != "exact_train_only_n5_gate_aligned_raster_nll_v15_development_fit"
        ...
        raise PermissionError("N5 gate-aligned raster-NLL V15 result crossed scope")
    review = result.get("source_review")
    if (
        not isinstance(review, Mapping)
        or set(review) != {"path", "file_sha256", "content_sha256"}
        or review.get("path") != SOURCE_REVIEW_RELATIVE_PATH
        or not all(
            is_sha256(review.get(key))
            for key in ("file_sha256", "content_sha256")
        )
    ):
        raise PermissionError("N5 gate-aligned raster-NLL V15 review binding changed")
    if expected_source_review is not None and dict(review) != dict(
        expected_source_review
    ):
        raise PermissionError("N5 gate-aligned raster-NLL V15 binds another review")
    attempt = result.get("attempt")
    if (
        not isinstance(attempt, Mapping)
        or set(attempt)
        != {"attempt_index", "maximum_attempts", "scope", "reservation"}
        or attempt.get("attempt_index") != 1
        or attempt.get("maximum_attempts") != 1
        or attempt.get("scope") != ATTEMPT_SCOPE
        or not isinstance(attempt.get("reservation"), Mapping)
    ):
        raise PermissionError("N5 gate-aligned raster-NLL V15 attempt scope changed")
    ...
    if (
        ...
        raise PermissionError("N5 gate-aligned raster-NLL V15 subset/target changed")
    if result.get("inputs") != _expected_exact_inputs(review):
        raise PermissionError("N5 gate-aligned raster-NLL V15 inputs changed")
    ...
    if (
        ...
        or set(model)
        != {"class", "fresh_initialization", "parameter_count", "checkpoint"}
        ...
        or isinstance(checkpoint.get("byte_count"), bool)
        or not isinstance(checkpoint.get("byte_count"), int)
        or checkpoint.get("byte_count", 0) <= 0
    ):
        raise PermissionError("N5 gate-aligned raster-NLL V15 model binding changed")
    ...
    if (
        ...
        or isinstance(resource.get("total_memory_bytes"), bool)
        or not isinstance(resource.get("total_memory_bytes"), int)
        or resource.get("total_memory_bytes", 0) < 16 * 1024**3
        or "r9700"
        not in "".join(
            character
        ...
        raise PermissionError("N5 gate-aligned raster-NLL V15 resource changed")
    ...
    if (
        ...
        or set(determinism) != determinism_fields
        or determinism.get("seed") != 20260710
        ...
        or isinstance(determinism.get("warning_count"), bool)
        or not isinstance(determinism.get("warning_count"), int)
        or determinism.get("warning_count", -1) < 0
        or not all(
            isinstance(determinism.get(field), list)
            for field in (
                "raw_messages",
                "normalized_messages",
                "normalization",
        ...
        or len(determinism.get("raw_messages", ()))
        != determinism.get("warning_count")
        or len(determinism.get("normalized_messages", ()))
        != determinism.get("warning_count")
        or len(determinism.get("normalization", ()))
        != determinism.get("warning_count")
        or not isinstance(determinism.get("kernel_counts"), Mapping)
        or set(determinism.get("kernel_counts", ()))
        != set(determinism.get("kernel_inventory", ()))
    ):
        raise PermissionError("N5 gate-aligned raster-NLL V15 determinism changed")
    ...
    worker_count = ledger.get("worker_count") if isinstance(ledger, Mapping) else None
    if (
        not isinstance(ledger, Mapping)
        or set(ledger) != expected_ledger_fields
        or ledger.get("selected_rgb_count") != 5
        or ledger.get("rgb_hash_opens") != 5
        or ledger.get("rgb_decodes") != 5
        or ledger.get("selected_rgb_rehashes_before_publication") != 5
        or isinstance(worker_count, bool)
        or not isinstance(worker_count, int)
        or not 1 <= worker_count <= 5
        or ledger.get("worker_start_method")
        not in {"inline_authority_revalidated", "spawn"}
        or (
            worker_count == 1
            and ledger.get("worker_start_method")
            != "inline_authority_revalidated"
        )
        or (worker_count > 1 and ledger.get("worker_start_method") != "spawn")
        or ledger.get("native_threads_per_worker") != 1
        or ledger.get("dataset_root_inventory_revalidations") != 1
        or ledger.get("shard_directory_inventory_revalidations") != 20
        or ledger.get("dataset_frame_revalidations") != 320
        or any(
            isinstance(ledger.get(key), bool)
            or not isinstance(ledger.get(key), int)
            or ledger.get(key, 0) <= 0
            for key in (
                "dataset_file_rehashes",
                "trainer_source_rehashes",
                "dataset_source_rehashes",
        ...
        or any(ledger.get(key) != 0 for key in forbidden_ledger)
    ):
        raise PermissionError("N5 gate-aligned raster-NLL V15 access crossed scope")
    ...
    if licenses_value != expected_licenses:
        raise PermissionError("N5 gate-aligned raster-NLL V15 licenses changed")
    # The V15 validator above owns the complete hierarchical result schema.
    # A retained-V1 result shadow would leak the legacy-name compatibility view
    # outside the metric-gate stack, which the V15 amendment explicitly forbids.
    return dict(result)
...
__all__ = [name for name in tuple(globals()) if name.isupper()] + [
    "adapt_native_v15_evaluation_for_retained_v4_gate",
    ...
    "frozen_source_bindings",
    "gpu_visibility_contract", "is_sha256", "isolated_verifier_contract", "licenses", "load_hashed_json",
    "parse_bound_path",
    ...
    "validate_evaluation_structure", "validate_gpu_visibility_reservation_binding", "validate_reservation_structure",
    "reconstruct_retained_v4_gate", "validate_result_structure",
]
