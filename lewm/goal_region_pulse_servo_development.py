"""Goal-region pulse feedback: internal approach threshold cannot override actual goal."""
import math
import numpy as np
...
RULES=dict(target_xy_m=[.4,0.],target_yaw_rad=.3,approach_tolerance_m=.06,
