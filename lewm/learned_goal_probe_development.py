...
The historical short-pulse model is unqualified for this moving distribution.
This controller has no native state, collision geometry or outcome-label input.
...
class LearnedGoalProbe:
    def __init__(self, model):
        self.model = model
        self.motion = JointTemporalAnchorVisualLedMotion(identity=(0, 0, 0))
    ...
    def _result(self, command, selection, distance):
        return dict(controller='learned_goal_bootstrap_probe_v1', requested_command=command,
