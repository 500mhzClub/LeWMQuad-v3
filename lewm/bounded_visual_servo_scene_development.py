...
def specification(condition):
    ...
    return previous|dict(trial=condition,scene_id='bounded-visual-servo-v1-'+condition,
        family='CONTROLLED_FLOOR_IDEAL_CAMERA_VISUAL_SERVO',procedural_seed=2026090645,
        appearance_seed=2026090647,friction_mu=FRICTION[condition],
        geometry=previous['geometry']|dict(spawn_se2_world=[-.65,.15,.12]),
