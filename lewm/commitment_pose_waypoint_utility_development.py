"""Development waypoint value over the actually committed half-second horizon.
...
def score_commitment_pose(selection):
    ...
    result.update(action=ACTIONS[chosen],action_index=chosen,requested_command=candidate_commands(ACTIONS[chosen])[0],
        score_contract='half_second_waypoint_distance_and_bearing_potential_minus_contact',
        scored_horizon_ns=500_000_000,turn_length_m=TURN_LENGTH_M,
