"""Explicit variable mission target; original measured route/view logic."""
import math
import numpy as np
...
class MissionTargetWaypointSelector:
    def __init__(self, *, condition, variant, goal_initial_body_xy_m):
