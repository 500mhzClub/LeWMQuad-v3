...
from scripts import build_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_development_v1_plan as plan_builder
from scripts import run_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_development_v1 as harness
...
QUALIFICATION_PLAN_BYTE_COUNT = 350_749
...
class CpuFlatDevelopmentQualificationHarnessTest(unittest.TestCase):
    ...
    def test_child_environment_is_exact_nine_keys(self):
        plan = {
            "execution_contract": {
