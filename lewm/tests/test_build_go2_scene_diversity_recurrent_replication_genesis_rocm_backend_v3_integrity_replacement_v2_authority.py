...
from scripts import (
    build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v2_authority
    as authority,
)
...
def test_scientific_authority_binds_exact_pass_and_review_only_evidence(
    ...
    assert result["predecessor_v3_qualification_terminal_review_binding"] == (
        authority.qualification_authority._v3_terminal_review_binding()  # noqa: SLF001
    )
    assert result[
        "predecessor_replacement_v1_qualification_terminal_review_binding"
    ] == (
        authority.qualification_authority._replacement_v1_terminal_review_binding()  # noqa: SLF001
    )
...
def test_no_replacement_scientific_authority_or_attempt_exists() -> None:
