...
from scripts import recent_qualified_direct_flow_native_prefix_development as prefix
from scripts.replay_go2_recent_qualified_direct_flow_maze03_prefix_v1 import CASE
from scripts.recent_qualified_direct_flow_native_prefix_development import INPUT_SHA
...
def evidence():
    ...
    report=dict(case=CASE[0],layout_index=3,frames=3,maximum_frames=MAX_FRAMES,model_state_sha256=MODEL_STATE,
    ...
    result=dict(status='RECENT_QUALIFIED_DIRECT_FLOW_MAZE03_PREFIX_V1_COMPLETE',native_result_sha256=INPUT_SHA,
