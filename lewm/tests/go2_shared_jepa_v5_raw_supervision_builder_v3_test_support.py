"""Production-ineligible synthetic authority support for Builder V3 tests only."""
...
from lewm.datasets import go2_shared_jepa_v5_raw_supervision_builder_v3 as builder
...
def validate_phase_two_for_tests(
    phase_one: builder.PhaseOneAuthorizationV3,
    *,
    repository_root: Path,
    reader: Reader,
) -> tuple[builder.AcceptedAuthorizationV3, tuple[str, ...]]:
    ...
    if type(phase_one) is not builder.PhaseOneAuthorizationV3:
        raise TypeError("test phase two requires a completed V3 phase-one capsule")
    ...
    return (
        builder.AcceptedAuthorizationV3(
            authorization_file_sha256=phase_one.authorization_file_sha256,
