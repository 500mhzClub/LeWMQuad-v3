...
from scripts import build_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_development_v2_plan as plan_builder
from scripts import run_go2_scene_diversity_recurrent_replication_genesis_cpu_flat_development_v2 as harness
...
QUALIFICATION_PLAN_BYTE_COUNT = 353_031
...
class CpuFlatDevelopmentQualificationHarnessTest(unittest.TestCase):
    ...
    def test_child_environment_is_exact_ten_keys_with_fixed_home(self):
        plan = {
            "execution_contract": {
