...
import numpy as np
import pytest
from scripts import reactive_nominal_native_prefix_comparison_development as module
...
def pair(tmp_path, monkeypatch):
    ...
    for row in rows[new]:
        row['decision'].update(learned_model_used=False, candidate_future_outcomes_evaluated=False, new_selection={})
