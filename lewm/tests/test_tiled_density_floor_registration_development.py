...
import pytest
from lewm import tiled_density_floor_registration_development as candidate
...
def test_private_bindings_preserve_all_original_function_bodies():
    old=MeasuredFloorTransportRegistration.observe;new=candidate.TiledDensityFloorRegistration.observe
...
def test_initial_state_and_failure_latch_remain_original():
    old=MeasuredFloorTransportRegistration();new=candidate.TiledDensityFloorRegistration()
