...
from scripts import (
    build_go2_scene_diversity_recurrent_replication_genesis_rocm_backend_v3_integrity_replacement_v1_qualification_authority
    as authority,
)
...
def test_qualification_authority_binds_v1_v2_and_v3_reviews_only(
