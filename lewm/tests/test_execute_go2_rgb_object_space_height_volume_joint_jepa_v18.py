...
def test_parent_bindings_include_exact_prereg_and_scientific_witnesses() -> None:
    ...
    expected = {
        ...
        v18.REPLACEMENT_V1_PREREGISTRATION_PATH: (
            ...
            v18.REPLACEMENT_V1_PREREGISTRATION_BYTE_COUNT,
        ),
        v18.REPLACEMENT_V1_TERMINAL_FAILURE_RESULT_PATH: (
            v18.REPLACEMENT_V1_TERMINAL_FAILURE_RESULT_FILE_SHA256,
            v18.REPLACEMENT_V1_TERMINAL_FAILURE_RESULT_BYTE_COUNT,
        ),
