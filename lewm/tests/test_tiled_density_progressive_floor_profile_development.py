...
from scripts import profile_go2_tiled_density_progressive_floor_late_history_v1 as profile
...
@pytest.mark.parametrize('mode', ['once', 'none', 'twice', 'wrong_path', 'cli_changed'])
