...
class CachedRGBDReplay:
    def __init__(self,directory):
        ...
        if not isinstance(self.frames,list) or not 1<=len(self.frames)<=3606:raise SensorContractError('bounded actual frame population required')
